...
pub use commands::{
    ...
    __cmd__chat_generate_lorebook_entry_draft, __cmd__chat_generate_scene_image,
    ...
    __cmd__reset_companion_template, __cmd__reset_design_reference_template,
    __cmd__reset_dynamic_memory_local_template, __cmd__reset_dynamic_memory_template,
    __cmd__reset_dynamic_summary_template, __cmd__reset_group_chat_roleplay_template,
    __cmd__reset_group_chat_template, __cmd__reset_help_me_reply_conversational_template,
    __cmd__reset_help_me_reply_template, __cmd__reset_local_roleplay_template,
    __cmd__reset_lorebook_entry_writer_template, __cmd__reset_scene_generation_template,
    ...
    chat_completion, chat_continue, chat_generate_design_reference_description,
    chat_generate_lorebook_entry_draft, chat_generate_scene_image, chat_generate_scene_prompt,
    ...
    reset_avatar_generation_template, reset_companion_template, reset_design_reference_template,
    reset_dynamic_memory_local_template, reset_dynamic_memory_template,
    reset_dynamic_summary_template, reset_group_chat_roleplay_template, reset_group_chat_template,
    ...
    reset_scene_generation_template, reset_scene_prompt_writer_template, retry_dynamic_memory,
