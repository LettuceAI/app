...
export const filMessages: DeepPartialMessageTree<LocaleMessages> = {
  ...
  accessibility: {
    ...
    navigation: {
      styleTitle: "Estilo ng navigation bar",
      bottom: "Bottom Bar",
      bottomDesc: "Bar na puro icon sa ibabang gilid",
      bottomLabels: "Bottom Bar na may Mga Label",
      bottomLabelsDesc: "Nagdaragdag ng text label sa ilalim ng bawat icon",
      dock: "Floating Dock",
      dockDesc: "Nakagitnang pill na hiwalay sa ibabang gilid",
      sidebar: "Sidebar",
      sidebarDesc: "Patayong icon rail na nakadikit sa gilid ng window",
      floatingSidebar: "Floating Sidebar",
      floatingSidebarDesc: "Patayong pill na hiwalay sa gilid ng window",
      side: "Posisyon ng sidebar",
      sideDesc: "Kung aling gilid ang may sidebar",
      sidebarFallbackNote: "Sa makikitid na window, lumilipat ang mga sidebar sa bottom style.",
      placement: "Posisyon",
      placementDesc: "Kung saan nakalagay ang navigation sa gilid nito",
      posTop: "Itaas",
      posMiddle: "Gitna",
      posBottom: "Ibaba",
      posCenter: "Sentro",
      itemsTitle: "Mga Item ng Navigation",
      itemsDesc: "I-drag para muling ayusin. Nananatili sa bar ang Create. Naaangkop sa desktop.",
      itemsReset: "I-reset",
      itemsAdd: "Magdagdag ng item",
      itemsRemove: "Alisin ang {{label}}",
      insideHeader: "Nasa Loob ng Header",
      insideHeaderDesc: "Mga navigation item na nakasentro sa loob ng page header",
      header: "Header",
      headerDesc: "Kung paano iginuguhit ang page header sa mga pangunahing pahina",
      header_auto: "Tumugma sa navigation",
      header_attached: "Nakadikit",
      header_floating: "Lumulutang",
      header_inline: "Sa pahina",
    },
    language: {
  ...
  components: {
    ...
    avatarGeneration: {
      ...
      localEditingUnavailable: "Hindi available ang pag-edit ng avatar sa mga lokal na modelong bumubuo ng larawan.",
      aiAssistant: "AI Assistant",
      backToResults: "Bumalik sa prompt",
      magicInTheWorks: "Gumagana ang mahika...",
      refine: "I-refine",
      apply: "I-apply",
      queuedWithPosition: "Naghihintay sa pila (posisyon {{position}})",
      loadingModel: "Naglo-load ng modelo...",
      preparing: "Naghahanda...",
      samplingProgress: "Hakbang {{step}} ng {{steps}}",
      finalizing: "Tinatapos...",
      retryingWithOffload: "Naubusan ng memory. Sinusubukan muli gamit ang CPU offload...",
      cancelGeneration: "Ihinto",
      cancelling: "Inihihinto...",
      paintMask: "Pinturahan ang bahagi",
      paintMaskHint: "Muling ginagawa ang mga pininturahang bahagi. Nananatiling pareho ang lahat ng iba pa.",
      brushSize: "Laki ng brush",
      clearMask: "Burahin",
      upscale: "I-upscale",
      upscaling: "Ina-upscale ang larawan...",
      upscaleFailed: "Bigo sa pag-upscale ng larawan",
    },
    avatarPosition: {
  ...
  chats: {
    ...
    companionRelationship: {
      ...
      soulGrowthConfidence: "Kumpiyansa",
      soulGrowthLock: "I-lock ang fact na ito",
      soulGrowthUnlock: "I-unlock ang fact na ito",
      soulGrowthLocked: "Naka-lock",
      soulGrowthPolicyHistorical: "Makasaysayan",
      soulGrowthPolicyCurrent: "Kasalukuyan",
      soulGrowthPolicyAdaptive: "Naaangkop",
    ...
    debugPage: {
      ...
      tokenBreakdown: "Paggamit ng Konteksto",
      tokenBreakdownEstimate: "Tantiya — tiktoken o200k (tinatantiya lamang; iba ang magiging resulta ng sariling tokenizer ng modelo)",
      tokenBreakdownCalibrated: "Breakdown",
      tokenBreakdownTotal: "Kabuuang prompt",
  ...
  groupChats: {
    ...
    overrides: {
      ...
      participantsAndMutedOverridden: "Binago ang mga kalahok at mute para sa chat na ito",
    },
    memories: {
    ...
    modelOverrides: {
      title: "Mga modelo ng karakter",
      subtitle: "Pumili ng ibang modelo para sa isang karakter",
      loading: "Naglo-load ng mga modelo...",
      overrideBadge: "Override",
      selectFor: "Modelo para kay {name}",
      useCharacterDefault: "Gamitin ang modelo ng karakter",
      inheritedValue: "{{model}} (default ng karakter)",
      missingModel: "Wala ang napiling modelo",
      noModel: "Walang naka-configure na modelo",
    },
    promptOverride: {
      title: "System prompt ng grupo",
      conversationSubtitle: "Ginagamit sa bawat sagot sa conversation group na ito",
      roleplaySubtitle: "Ginagamit sa bawat sagot sa roleplay group na ito",
      useCharacterDefault: "Gamitin ang prompt ng bawat karakter",
      hint: "Pinapalitan nito ang group prompt na gagamitin ng bawat karakter nang mag-isa.",
    },
  },
  characters: {
    companionSetup: {
    ...
    conflicts: {
      title: "Kailangang suriin",
      reviewTitle: "May mga pagbabagong kailangan ng desisyon mo",
      reviewDescription: "Ligtas na natapos ang pag-sync. Piliin ang bersyong pananatilihin para sa bawat item.",
      waitForSync: "Tapusin muna ang kasalukuyang pag-sync bago suriin ang mga pagbabago.",
      fieldsDiffer: "{{count}} field ang magkaiba",
      currentVersion: "Kasalukuyang bersyon",
      otherVersion: "Ibang bersyon",
      device: "Device {{id}}",
      detected: "Natukoy noong {{date}}",
      emptyValue: "Walang laman",
      keepCurrent: "Panatilihin ito",
      useOther: "Gamitin ang iba",
      loadError: "Hindi ma-load ang detalye ng conflict.",
      resolveError: "Hindi na-save ang pinili. Walang binago.",
      entities: {
        item: "Item",
        character: "Character",
        persona: "Persona",
        lorebook: "Lorebook",
        lorebookEntry: "Entry sa lorebook",
        promptTemplate: "Prompt template",
      },
      fields: {
        changedValue: "Binagong value",
        name: "Pangalan",
        nickname: "Palayaw",
        title: "Pamagat",
        description: "Paglalarawan",
        ...
        scenario: "Senaryo",
        creatorNotes: "Tala ng gumawa",
        tags: "Mga tag",
        systemPrompt: "System prompt",
        keywordDetection: "Pagtukoy ng keyword",
        content: "Nilalaman",
        keywords: "Mga keyword",
        enabled: "Naka-enable",
        alwaysActive: "Laging aktibo",
        priority: "Priyoridad",
        entries: "Mga prompt entry",
      },
    },
    lorebook: {
      keywords: "MGA KEYWORD",
  ...
  models: {
    ...
    menu: {
      ...
      duplicateDescription: "Gumawa ng kopya ng modelong ito",
    ...
    toasts: {
      ...
      importFailed: "Nabigo ang import",
      duplicateSuccessTitle: "Na-duplicate ang modelo",
      duplicateSuccessDescription: "Nalikha ang {{name}}.",
      duplicateFailed: "Hindi na-duplicate",
    },
    downloadQueue: {
  ...
  editModel: {
    ...
    moveModel: {
      ...
      moveAllTitle: "Ilagay ang mga File sa Library",
      moveAllDescription: "Ilipat ang modelong ito at ang draft at vision files nito sa LettuceAI GGUF library folder.",
      moveAllAction: "Ilipat sa library",
      moveAllMoving: "Inililipat ang mga file...",
      moveAllDone: "Nasa library na ang lahat ng file",
      movedAllTitle: "Nailipat ang mga file",
      movedAllBody: "Nasa GGUF library na ang modelong ito at ang mga sidecar file nito.",
    },
    editorMode: {
    ...
    setup: {
      ...
      sdcppManaged: "Pumili mula sa mga modelong naka-install sa device na ito. Awtomatikong pinamamahalaan ang entry at ang mga file nito.",
      sdcppSelectModel: "Piliin ang naka-install na modelo",
      sdcppCustomHelp: "Ituro ang main model GGUF file sa disk, pagkatapos ay itakda ang text encoder at VAE files nito sa Configuration tab.",
    },
    runtime: {
    ...
    sdcpp: {
      baseLoras: "Mga Base LoRA",
      baseLorasDescription: "Ang mga LoRA na ito ay nilo-load sa bawat pagbuo gamit ang modelong ito. Idinadagdag sa ibabaw ang mga LoRA ng karakter at estilo.",
      addLora: "Magdagdag ng LoRA",
      noBaseLoras: "Walang naka-configure na LoRA sa antas ng modelo",
      chooseLora: "Pumili ng LoRA",
      loraPath: "Path ng LoRA",
      strength: "Lakas",
      loraKeywords: "Mga trigger keyword",
      loraKeywordsDescription: "Awtomatikong idinaragdag kapag aktibo ang LoRA na ito",
      editKeywords: "I-edit ang keywords",
      keywordsRequired: "Magdagdag ng LoRA keyword",
      keywordsRequiredDescription: "Magdagdag ng kahit isang trigger keyword bago i-save ang modelo.",
      loraAlwaysActive: "Palaging aktibo, walang trigger keyword",
      markLoraAlwaysActive: "Hindi kailangan ng keyword ang LoRA na ito, markahan bilang palaging aktibo",
      keywordEditorTitle: "Mga LoRA keyword",
      keywordEditorDescription: "Maglagay ng isang keyword bawat linya o paghiwalayin gamit ang kuwit. Mae-edit pa rin ang awtomatikong nahanap na mga value.",
      ...
      removeIncompatibleLora: "Alisin ang mga hindi compatible na LoRA bago i-save ang modelong ito.",
      loraCompatibilityUnknown: "Hindi matukoy ang compatibility",
      loraCompatibilityUnknownDescription: "Hindi tinutukoy ng LoRA ang eksaktong base architecture nito. Maaari mo itong subukan, pero hindi garantisado ang compatibility.",
      removeLora: "Alisin ang LoRA",
      installedFiles: "Mga naka-install na file",
      installedFilesDescription: "Ang mga pinamamahalaang path ng modelo at component na kasalukuyang ipinapasa sa stable-diffusion.cpp.",
      modelPath: "Path ng modelo",
      textEncoderPath: "Path ng text encoder",
      visionEncoderPath: "Path ng vision encoder",
      vaePath: "Path ng VAE",
      noInstalledFiles: "Pumili ng naka-install na lokal na image model para makita ang mga file nito.",
      loraFiles: "Mga LoRA file",
      modelFilesFilter: "Mga file ng diffusion model",
      importLora: "Mag-import ng LoRA file",
      importLoraDescription: "Kopyahin ang LoRA sa lokal na library ng image generation",
      importFailed: "Nabigo ang pag-import ng LoRA",
      modelFiles: "Mga file ng modelo",
      modelFilesDescription: "Mga file na ipinapasa ng modelong ito sa stable-diffusion.cpp. Ang main model path sa itaas ay ang diffusion GGUF; kailangan ang text encoder at VAE para makatakbo, at ang vision encoder ay para lang sa mga image editing model.",
      textEncoder: "Text encoder",
      vae: "VAE",
      visionEncoder: "Vision encoder",
      optionalFile: "opsyonal",
      modelFilesIncomplete: "Itakda ang text encoder at VAE files. Hindi magsisimula ang paggawa hangga't hindi kumpleto ang configuration ng modelong ito.",
      detectedArchitecture: "Natukoy na architecture: {{name}}",
      detectFailed: "Hindi matukoy ang architecture ng file na ito. Manu-manong itakda ang mga component file.",
      componentsRequiredTitle: "Kulang ang mga file ng modelo",
      componentsRequiredBody: "Punan ang mga naka-highlight na component file bago mag-save.",
      componentFilesFilter: "Mga component file ng modelo",
      chooseFromLibrary: "Pumili mula sa Library",
      componentPickerTitle: "Pumili ng Component File",
      componentLibraryEmpty: "Walang tugmang file sa iyong library",
      componentLibraryEmptyHint: "Mag-install muna ng lokal na image model o mag-download ng mga encoder file gamit ang model browser.",
      sourceImageComponents: "Mga component ng larawan",
      sourceLlmLibrary: "LLM library",
      sourceImageDownloads: "Mga na-download na file",
    },
    modelSource: {
    ...
    generationAdvanced: {
      title: "Advanced na pagbuo",
      description: "Sampling, VAE tiling, mga reference, at high-resolution pass",
      modelDefault: "Default ng modelo",
      sampler: "Sampler",
      scheduler: "Scheduler",
      schedulerDescription: "Noise schedule na ginagamit sa mga sampling step",
      imageGuidance: "Image CFG",
      imageGuidanceDescription: "Lakas ng guidance para sa mga reference image",
      distilledGuidance: "Distilled guidance",
      distilledGuidanceDescription: "Guidance na partikular sa distilled architectures",
      samplingSection: "Sampling",
      eta: "Eta",
      etaDescription: "Stochastic noise para sa mga compatible na sampler",
      flowShift: "Flow shift",
      flowShiftDescription: "Timestep shift para sa flow-based na mga modelo",
      vaeSection: "VAE tiling",
      vaeTiling: "Gamitin ang VAE tiling",
      vaeTilingDescription: "I-decode ang image nang pira-piraso para mabawasan ang peak memory",
      tileWidth: "Lapad ng tile",
      tileHeight: "Taas ng tile",
      tileOverlap: "Overlap ng tile",
      referencesSection: "Mga reference image",
      autoResizeReferences: "Awtomatikong i-resize ang references",
      autoResizeReferencesDescription: "Itugma ang references sa laki ng generation",
      increaseReferenceIndex: "Dagdagan ang reference index",
      increaseReferenceIndexDescription: "Bigyan ang bawat reference ng sariling positional index",
      hiresSection: "High-resolution pass",
      hiresFix: "I-enable ang high-resolution pass",
      hiresFixDescription: "I-upscale at pinuhin ang unang resulta sa ikalawang pass",
      upscaler: "Upscaler",
      scale: "Scale",
      targetWidth: "Target na lapad",
      targetHeight: "Target na taas",
      secondPassSteps: "Mga step ng ikalawang pass",
      denoisingStrength: "Lakas ng denoising",
      stepCaching: "Step caching",
      stepCachingDescription: "Muling gamitin ang magkakatulad na diffusion step para mapabilis ang paggawa kapalit ng bahagyang kalidad",
      cacheMode: "Cache mode",
      cacheModeDisabled: "Naka-disable",
      cacheOption: "Pag-tune ng cache",
      cacheOptionPlaceholder: "threshold=0.2, start=0.15",
      slgSection: "Skip-layer guidance",
      slgSectionDescription: "Ginagabayan ang sampling sa pamamagitan ng paglaktaw sa mga transformer layer. Iwanang blangko ang scale para manatiling naka-off.",
      slgScale: "Guidance scale",
      slgDisabled: "Off",
      slgLayers: "Mga nilaktawang layer",
      slgLayerStart: "Simulang fraction",
      slgLayerEnd: "Panghuling fraction",
    },
    generationDescriptions: {
      ...
      sdSampler: "Diffusion sampler na ginagamit ng image engine",
      sdSeed: "Leave blank for random generations",
      sdDenoise: "Edit strength for reference-based generations",
      sdNegativePrompt: "Inilalapat sa bawat image request para sa modelong ito",
    ...
    llamaSampler: {
      ...
      adaptiveTargetDescription: "Target na probabilidad para sa Adaptive-P; iwanang blangko para panatilihin ang karaniwang huling sampling step",
      adaptiveDecay: "Adaptive-P Target Decay",
      adaptiveDecayDescription: "Mas mababa ay mas mabilis tumugon sa mga kamakailang token, mas mataas ay mas matatag",
    },
    mtp: {
    ...
    dflash: {
      ...
      description: "Nagda-draft ng buong block ng token bawat step gamit ang DFlash draft file. Inuuna ito kaysa sa MTP kapag may available na draft file.",
      toggle: "I-toggle ang DFlash speculative decoding",
      visionWarningTitle: "Hindi available ang DFlash para sa vision",
      visionWarningDescription: "Magpapatuloy ang mga image request nang walang DFlash habang may naka-configure na MMProj vision file.",
      placement: "Placement ng Draft Model",
      placementDescription: "Ginagamit ng Auto ang pinakamabilis na GPU na may sapat na espasyo",
      placementGpu: "GPU",
      placementCpu: "CPU",
      draftTokens: "Draft Tokens",
      draftTokensDescription: "Mga token na dina-draft bawat block, limitado ng na-train na block size ng draft file (1 hanggang 15)",
      minProbability: "Pinakamababang Kumpiyansa",
      minProbabilityDescription: "Humihinto ang pag-draft sa unang token na mas mababa sa kumpiyansang ito (0 hanggang 1)",
      draftFile: "DFlash Draft File",
      draftFileDescription: "DFlash draft GGUF na na-train para sa modelong ito. Awtomatikong natutuklasan mula sa sibling na *dflash*.gguf kapag walang laman.",
      draftFilePlaceholder: "Auto-discover",
    },
  },
  playground: {
    ...
    title: "Playground",
    back: "Bumalik",
    open: "Buksan ang Playground",
    openDescription: "Malayang gumawa ng mga larawan gamit ang mga prompt, setting ng modelo, at LoRA.",
    promptTab: "Prompt",
    settingsTab: "Mga Setting",
    emptyFeed: "Wala pang nagawang larawan",
    emptyFeedHint: "Sumulat ng prompt at pindutin ang Generate.",
    settings: {
      model: "Modelo",
      pickModel: "Pumili ng image model",
      noModel: "Walang napiling image model",
      generation: "Pagbuo",
      size: "Laki",
      sizePlaceholder: "hal. 1024x1024",
      steps: "Mga hakbang",
      cfg: "CFG scale",
      sampler: "Sampler",
      scheduler: "Scheduler",
      seed: "Seed",
      seedRandom: "Random",
      rollSeed: "Mag-roll ng random na seed",
      batch: "Bilang ng batch",
      quality: "Kalidad",
      style: "Estilo",
      defaultOption: "default",
      hires: "Hires fix",
      hiresUpscaler: "Upscaler",
      hiresNone: "Walang naka-install na upscaler",
      hiresScale: "Scale",
      hiresSteps: "Mga hires step",
      hiresDenoising: "Denoising",
    },
    loras: {
      title: "Mga LoRA",
      add: "Magdagdag",
      empty: "Walang naka-apply na LoRA.",
      pickerTitle: "Magdagdag ng LoRA",
      none: "Wala pang LoRA sa iyong library. Buksan ang LoRA Library para mag-download.",
      openLibrary: "Buksan ang LoRA Library",
    },
    prompt: {
      label: "Prompt",
      placeholder: "Ilarawan ang larawang gusto mong gawin...",
      negativeLabel: "Negative prompt",
      negativePlaceholder: "Kung ano ang iiwasan...",
      generate: "I-generate",
      generating: "Ginagawa...",
      shortcutHint: "Ctrl+Enter para gumawa",
      initImageLabel: "Image to image",
      pickInitImage: "Pumili ng panimulang larawan",
      pickInitImageFile: "Mula sa file",
      pickInitImageHistory: "Mula sa history",
      pickFromHistory: "Pumili mula sa iyong mga nagawa",
      noHistoryImages: "Wala pang nakaraang nagawa. Gumawa muna ng ilang larawan.",
      clearInitImage: "Alisin",
      strength: "Lakas",
      initImageFailed: "Hindi ma-load ang larawang iyon",
      initImageSet: "Naitakda ang panimulang larawan",
    },
    progress: {
      starting: "Sinisimulan",
      loading: "Nilo-load ang modelo",
      queued: "Naghihintay sa pila",
      generating: "Ginagawa",
      sampling: "Nagsa-sample",
      retrying: "Sinusubukan muli nang mas kaunti ang gamit na memory",
    },
    feed: {
      loadOlder: "Mag-load ng mas lumang mga nagawa",
      cancel: "Kanselahin ang paggawa",
      failed: "Bigo ang paggawa",
      cancelled: "Kinansela ang paggawa",
      interrupted: "Naantala ang paggawa",
      delete: "Burahin ang nagawang larawan",
      sendToImg2img: "Gamitin bilang panimulang larawan",
      upscale: "I-upscale",
      upscaleFailed: "Bigo ang pag-upscale",
      copyPrompt: "Kopyahin ang prompt",
      promptCopied: "Nakopya ang prompt",
      reuseSeed: "Gamitin muli ang seed na ito",
      seedReused: "Naitakda ang seed sa {{seed}}",
      regenerate: "I-regenerate gamit ang parehong mga setting",
      modelMissing: "Hindi na available ang modelong iyon",
      deleteTitle: "Burahin ang nagawang larawan",
      deleteBody: "Alisin ang nagawang ito sa feed. Puwede mong panatilihin ang mga image file o burahin din ang mga ito sa disk.",
      deleteKeepImages: "Burahin ang entry, panatilihin ang mga larawan",
      deleteWithImages: "Burahin ang entry at mga larawan",
      deleteFailed: "Bigo ang pagbura",
    },
  },
  loraLibrary: {
    title: "LoRA Library",
    ...
    importButton: "Mag-import ng file",
    importSuccess: "Na-import ang LoRA",
    importFailed: "Nabigo ang pag-import",
    installedEmpty: "Wala pang LoRA sa iyong library",
    installedEmptyHint: "Mag-download mula sa CivitAI o mag-import ng lokal na file.",
    noKeywords: "Wala pang trigger keyword",
    discover: "Hanapin ang mga keyword",
    discoverFailed: "Nabigo ang paghahanap ng keyword",
    editKeywords: "I-edit ang mga keyword",
    deleteTitle: "Burahin ang LoRA",
    deleteMessage: "Burahin ang {{name}} mula sa iyong library? Aalisin ang file sa disk.",
    deleteConfirm: "Burahin",
    deleteSuccess: "Nabura ang LoRA",
    deleteFailed: "Nabigo ang pagbura",
    keywordsTitle: "Mga trigger keyword",
    keywordsHint: "Isang keyword bawat linya. Idinadagdag ang mga ito sa mga prompt na gumagamit ng LoRA na ito.",
    keywordsSave: "I-save ang mga keyword",
    keywordsRequired: "Magdagdag ng kahit isang trigger keyword.",
    keywordsSaveFailed: "Nabigo ang pag-save ng mga keyword",
    searchPlaceholder: "Maghanap ng LoRA sa CivitAI...",
    sortTitle: "Ayusin ang mga resulta",
    sortHighestRated: "Pinakamataas ang rating",
    sortMostDownloaded: "Pinakamaraming download",
    sortNewest: "Pinakabago",
    periodTitle: "Saklaw ng panahon",
    periodAllTime: "Lahat ng panahon",
    periodYear: "Nakaraang taon",
    periodMonth: "Nakaraang buwan",
    periodWeek: "Nakaraang linggo",
    periodDay: "Ngayon",
    baseModelAll: "Lahat ng base model",
    pureModeNote: "Naka-on ang Pure mode. Mga ligtas na resulta lang ang ipinapakita.",
    noResults: "Walang nahanap na LoRA",
    noResultsHint: "Sumubok ng ibang salita.",
    loadMore: "Mag-load pa",
    by: "ni {{name}}",
    showImage: "Ipakita ang larawan",
    backToResults: "Bumalik sa mga resulta",
    backToCaller: "Bumalik",
    copyLink: "Kopyahin ang CivitAI link",
    alwaysActive: "Palaging aktibo, walang trigger keyword",
    copied: "Nakopya sa clipboard",
    versions: "Mga bersyon",
    triggerWords: "Mga trigger word",
    filesTitle: "Mga file",
    noSafeFiles: "Walang safetensors file ang bersyong ito.",
    primaryFile: "Pangunahin",
    download: "I-download",
    downloaded: "Nasa library na",
    downloadQueued: "Naka-queue ang download",
    downloadFailed: "Nabigo ang download",
    detailLoadFailed: "Hindi ma-load ang model na ito.",
    openLibrary: "Buksan ang LoRA library",
    openLibraryDescription: "Mag-browse at mag-download ng LoRA. Mawawala ang mga hindi na-save na pagbabago sa model.",
    tokenTitle: "CivitAI API token",
    tokenBody: "Magdagdag ng CivitAI API token para ma-download ang mga restricted o early-access na file.",
    tokenGetOne: "Kumuha ng token sa CivitAI",
    ...
    tokenAdd: "Magdagdag ng token",
    tokenReplace: "Palitan ang token",
    tokenRemove: "Alisin ang token",
    tokenPrivacy: "Ang token ay naka-save nang lokal at ipinapadala lang sa CivitAI.",
  },
  hfAuth: {
  ...
  hfBrowser: {
    ...
    modeLlm: "LLM",
    modeImage: "Larawan",
    destinationLlamaCpp: "Lokal na llama.cpp",
    destinationLocalImage: "Lokal na Larawan",
    destinationSelectDownload: "Piliin at I-download",
    bundle: {
      title: "Bumuo ng image model",
      subtitle: "Pumili ng compatible na architecture at mga component. Ipi-pin, ibe-verify, ida-download, at irerehistro ng LettuceAI ang buong bundle.",
      verifiedInstaller: "Na-verify na bundle installer",
      chooseArchitecture: "Pumili ng architecture recipe",
      changeArchitecture: "Palitan ang architecture",
      formatLabel: "Format",
      formatGguf: "GGUF",
      formatSafetensors: "Safetensors",
      formatHint: "Maghanap ng mga repository na inilathala sa format na ito. Naaabot ng Safetensors ang maraming image repository na hindi kailanman naglalabas ng GGUF build.",
      changeProfileConfirm: "Mabubura ang mga hindi compatible na pinili. Magpatuloy?",
      componentStep: "Component {{current}} sa {{total}}",
      selectRole: "Piliin ang {{role}}",
      repositoryPlaceholder: "author/repository o Hugging Face URL",
      searchPlaceholder: "Maghanap ng compatible na repository o mag-paste ng Hugging Face URL",
      selectFile: "Piliin",
      selectFileHeading: "Piliin ang {{role}} file",
      compatibleFiles: "{{count}} compatible na file",
      noCompatibleFiles: "Walang nakitang compatible na {{role}} file sa repository na ito.",
      noCompatibleRepositories: "Walang nakitang compatible na repository para sa component na ito. Subukan ang ibang paghahanap o mag-paste ng repository URL.",
      recommendedPrefilled: "Ipinapakita ang inirerekomendang repository para sa component na ito.",
      reviewTitle: "Suriin at i-download",
      addToken: "Magdagdag ng Hugging Face token",
      authHint: "Maaaring mangailangan ang repository na ito ng Hugging Face token o pagtanggap sa lisensya nito.",
      selectionInvalid: "Hindi maibalik ang pagpili ng {{role}}. Piliin itong muli.",
      gated: "Limitadong access",
      hfAccess: "Hugging Face access",
      tokenPlaceholder: "Hugging Face access token",
      saveToken: "I-save ang token",
      tokenPrivacy: "Bine-verify ang token bago i-save at hindi ito ibinabalik sa interface o inilalagay sa download URL.",
      authInvalid: "Nabigo ang Hugging Face authentication",
      textToImage: "Text to image",
      imageEditing: "Pag-edit ng larawan",
      displayName: "Display name ng model",
      preDownloadEstimate: "Runnability estimate bago mag-download",
      runtimeRequired: "Mag-install at pumili ng compatible na stable-diffusion.cpp engine sa Lokal na Larawan bago mag-download.",
      calculating: "Kinakalkula ang placement gamit ang naka-save na compute policy…",
      bundleSize: "Laki ng bundle",
      placement: "Placement",
      devices: "Mga device",
      planConcurrent: "Sabay-sabay",
      planTimeShare: "Yugto-yugto",
      planDefaultBackend: "Default na backend",
      placementHeading: "Placement ng mga component",
      componentDit: "Diffusion core",
      componentVae: "VAE",
      componentConditioner: "Text encoder",
      splitAcross: "Hinati sa mga device",
      reserve: "reserba",
      deviceUsable: "{{free}} libre · {{budget}} magagamit sa {{total}}",
      availableRam: "{{value}} system RAM ang available",
      downloadCreate: "I-download at gawin ang model",
      queueFailed: "Hindi masimulan ang pag-download ng image bundle",
      verifying: "Bine-verify",
      registrationFailed: "Nabigo ang paggawa ng model",
      retryRegistration: "Subukang gawin muli ang model",
      retryDownloads: "Subukan muli ang mga hindi natapos na download",
      completeTitle: "Handa na ang image model",
      completeBody: "Na-verify at nairehistro ang {{name}}, at available na ito sa mga image selector.",
      openModel: "Buksan ang model",
      steps: "hakbang",
      manageEngine: "Pamahalaan ang stable-diffusion.cpp engine",
      roles: {
  ...
  imageGeneration: {
    ...
    local: {
      sectionTitle: "Mga lokal na image model",
      managedTitle: "Pinamamahalaang stable-diffusion.cpp",
      managedDescription: "Mag-install ng piniling model at hiwalay na engine build. Ihihinto ng engine ang lokal na text generation bago gamitin ang accelerator upang hindi mag-agawan sa GPU memory ang dalawang gawain.",
      refreshBuilds: "I-refresh ang mga engine build",
      modelVariant: "Variant ng model",
      engineVersion: "Bersyon ng engine",
      computeBackend: "Compute backend",
      latest: "pinakabago",
      installSelected: "I-install ang napili",
      installQueued: "Nakapila ang lokal na image model",
      sceneReady: "Mga reference ng eksena",
      textToImage: "Text patungong image",
      referenceCount: "Hanggang {{count}} reference",
      loraReady: "LoRA",
      fitResolution: "Test resolution",
      fitReferences: "Mga reference",
      testExactFit: "Subukan ang aktuwal na pagtakbo",
      fitTestDescription: "I-a-unload ng test ang lokal na text generation at magpapatakbo ng tunay na one-step sd.cpp graph. Hindi ito gumagamit ng VRAM estimate.",
      ...
      upscaler: {
        title: "Upscaler",
        description: "ESRGAN model ({{size}}) na ginagamit para sa Upscale action at sa high-resolution pass.",
        installed: "Naka-install",
        install: "I-install",
      },
      engineManager: {
        title: "Stable Diffusion Engine",
        description: "Mag-install at pumili ng stable-diffusion.cpp build na gagamitin sa lokal na paglikha ng larawan.",
        installedTitle: "Mga Naka-install na Bersyon",
        notInstalled: "Hindi Naka-install ang Engine",
        notInstalledBody: "Mag-install ng bersyon ng engine bago mag-set up ng mga lokal na image model.",
        active: "Aktibo",
        useVersion: "Gamitin ang Bersyong Ito",
        deleteVersion: "Burahin ang {{version}}",
        deleteConfirmTitle: "Burahin ang {{version}}?",
        deleteConfirm: "Aalisin nito ang engine build na ito sa disk.",
        deleteActiveConfirm: "Ito ang aktibong build. Awtomatikong pipiliin ang ibang naka-install na bersyon, kung mayroon.",
        addVersion: "Mag-install ng Ibang Bersyon",
        installTitle: "I-install ang Engine",
        version: "Bersyon",
        variant: "Variant ng Build",
        recommended: "Inirerekomenda",
        detectedGpu: "Natukoy ang {{device}}. Awtomatikong napili ang pinakamahusay na compatible na build.",
        noDiscreteGpu: "Walang natukoy na discrete GPU. Napili ang pinakaligtas na compatible na build.",
        manualVariant: "Manu-manong napili. Inirerekomenda ang {{backend}} para sa device na ito.",
        install: "I-install ang Engine",
        alreadyInstalled: "Naka-install Na",
        installing: "Ini-install ang engine",
        queued: "Nakapila ang download ng engine",
        downloads: "Mga Download ng Engine",
        cancelDownload: "Kanselahin ang download ng engine",
        installComplete: "Naka-install at handa na",
        installFailed: "Bigo ang pag-install ng engine",
        switchFailed: "Hindi mapalitan ang bersyon ng engine",
        deleteFailed: "Hindi mabura ang bersyon ng engine",
        inventoryFailed: "Hindi mabasa ang mga naka-install na bersyon ng engine",
        catalogFailed: "Hindi ma-load ang mga available na bersyon ng engine",
        computePolicyTitle: "Patakaran sa GPU",
        computePolicyDescription: "Piliin kung aling mga GPU ang puwedeng gamitin ng engine na ito at kung paano hinahati ng Stable Diffusion ang gawain ng modelo sa pagitan ng mga ito.",
        computePolicyConfigure: "I-configure",
        computePolicyLoading: "Binabasa ang mga compatible na GPU...",
        computePolicySave: "I-save ang Patakaran sa GPU",
        computePolicySaved: "Na-save ang patakaran sa GPU",
        computePolicySaveFailed: "Hindi ma-save ang patakaran sa GPU",
        computeMode: "Pagpili ng device",
        computeModeAuto: "Awtomatiko",
        computeModeAutoDescription: "Hayaang piliin ng stable-diffusion.cpp ang pinakamahusay na eligible na GPU placement para sa bawat modelo.",
        computeModeSingle: "Isang GPU",
        computeModeSingleDescription: "Panatilihin sa isang napiling device ang lahat ng gawain ng GPU.",
        computeModeMulti: "Maraming GPU",
        computeModeMultiDescription: "Gumamit ng dalawa o higit pang napiling device kapag may pakinabang sa paghahati ang isang modelo.",
        eligibleGpus: "Mga Eligible na GPU",
        noEligibleGpus: "Walang compatible na discrete GPU na available sa engine build na ito.",
        vramBudget: "Badyet ng VRAM",
        vramBudgetAuto: "Auto",
        vramBudgetHint: "{{available}} ang kasalukuyang libre; iwanang blangko para awtomatiko.",
        vramBudgetFor: "Badyet ng VRAM para sa {{device}}",
        splitMode: "Paghahati sa multi-GPU",
        splitLayer: "Paghahati ayon sa layer",
        splitLayerDescription: "Ipamahagi sa mga GPU ang kumpletong mga layer ng modelo.",
        splitRow: "Paghahati ayon sa row",
        splitRowDescription: "Hatiin ang bawat tensor row sa mga CUDA GPU.",
        rowCudaOnly: "Kailangan ng CUDA engine build ang row split.",
        computeSummaryAuto: "Awtomatiko · {{count}} eligible na GPU",
        computeSummarySingle: "Isang GPU · {{device}}",
        computeSummaryMulti: "Maraming GPU · {{count}} ang napili",
      },
      modelLibrary: {
        title: "Mga Modelo",
        description: "Mag-download ng mga modelo para gumawa ng larawan nang lokal sa device na ito.",
        refreshHardware: "I-refresh ang hardware",
        refreshingHardware: "Sinusuring muli...",
        refreshHardwareDescription: "Muling basahin ang GPU memory at kalkulahin muli ang hardware fit para sa mga nakikitang variant ng modelo.",
        refreshFailed: "Hindi ma-refresh ang impormasyon ng hardware para sa modelo",
        variant: "Variant",
        download: "I-download",
        installing: "Nagda-download",
        installedShort: "Naka-install",
        needsReference: "Kailangan ng reference image para makagawa.",
        engineNeededForFit: "Mag-install ng engine build sa itaas bago mag-download ng mga modelo o suriin ang hardware fit.",
        noRuntime: "Mag-install ng Stable Diffusion engine build bago i-download ang modelong ito.",
        engineRequired: "I-install muna ang engine",
        engineUpdateRequired: "Kailangan ng engine build {{build}} o mas bago",
        updateEngineFirst: "I-update muna ang engine",
        fitChecking: "Sinusuri ang hardware fit...",
        fitFitsGpu: "Kasya sa iyong GPU",
        fitPhased: "Kasya sa iyong GPU, nilo-load nang pahakbang",
        fitCpuOffload: "Tumatakbo nang may CPU offload, mas mabagal",
        fitInconclusive: "Hindi tiyak ang hardware fit",
        fitVerified: "Na-verify sa iyong hardware",
        fitFailed: "Hindi tumakbo sa iyong hardware",
        more: "Higit pa",
        memorySummary: "Buod ng memory",
        modelWeights: "Mga weight file ng modelo",
        gpuPlacedWeights: "Nakalagay sa GPU",
        cpuOffloadedWeights: "Na-offload sa CPU",
        availableRam: "Available na RAM",
        strategy: "Estratehiya",
        planConcurrent: "Sabay-sabay na GPU",
        planTimeShare: "GPU, nilo-load nang pahakbang",
        planDefaultBackend: "CPU fallback",
        deviceMemory: "Memory ng GPU",
        freeMemory: "Libre",
        usableBudget: "Magagamit na badyet",
        noGpuPlacement: "Walang available na discrete GPU placement para sa planong ito.",
        componentPlacement: "Paglalagay ng component",
        weights: "Mga weight",
        computeReserve: "Reserba para sa compute",
        singleGpuNeed: "Kailangan sa isang GPU",
        split: "hati",
        offloadConfirmTitle: "I-download ang {{model}}?",
        offloadConfirm: "Hindi kasya sa iyong GPU ang modelong ito at mag-o-offload ito sa CPU at system RAM, kaya magiging mabagal ang paggawa. I-download pa rin?",
        modelCard: "Model card",
        queued: "Nakapila ang download ng modelo",
        installFailed: "Bigo ang download ng modelo",
        uninstallFailed: "Hindi maalis ang modelo",
        uninstallModel: "Alisin ang {{model}}",
        uninstallConfirmTitle: "Alisin ang {{model}}?",
        uninstallConfirm: "Buburahin nito sa disk ang mga weight ng modelo. Pananatilihin ang mga shared component na ginagamit ng ibang naka-install na modelo.",
        familyModelCount: "{{count}} na modelo",
        familyModelCountOne: "1 modelo",
        familyInstalledCount: "{{count}} ang naka-install",
      },
      entryCard: {
        manage: "Pamahalaan",
      },
      hub: {
        unsupportedTitle: "Hindi suportado sa system na ito",
        desktopOnlyTitle: "Desktop lang",
        desktopOnlyBody: "Available ang Stable Diffusion engine sa desktop app.",
      },
    },
  },
  logs: {
  ...
  sync: {
    ...
    progress: {
      ...
      phases: {
        ...
        separatingChatBranches: "Pinaghihiwalay ang sabay na mga sangay ng chat",
        waitingForDatabase: "Naghihintay sa lokal na database",
        comparingFiles: "Inihahambing ang mga file",
        exchangingFiles: "Ipinagpapalit ang mga file",
      },
      databaseWait: {
        title: "Abala ang lokal na database",
        description: "Tinatapos ng ibang gawain ang pagsusulat sa database. Ligtas na naka-pause ang sync at awtomatikong susubok muli.",
        retry: "Pagsubok {{current}} sa {{total}} sa loob ng {{delay}}",
      },
    },
  ...
  sessionAdvanced: {
    ...
    samplingMemory: {
      ...
      reasoning: "Reasoning",
      adaptiveTarget: "Adaptive-P Target",
      adaptiveTargetDesc: "Layunin ang mga token na malapit sa probabilidad na ito. Ang blangko ay nagpapanatili ng normal na sampling.",
      adaptiveDecay: "Adaptive-P Target Decay",
      adaptiveDecayDesc: "Kung gaano katatag ang pag-adapt ng target. Mas mababa ay mas mabilis tumugon.",
    },
    systemInfo: {
      title: "System Info",
  ...
  featureGeneration: {
    ...
    tabDescription: "I-configure kung paano nagsa-sample ang bawat feature ng app kapag ginagamit nito ang model na ito. Ang mga field na walang nakatakda ay nagmamana mula sa mga setting ng generation ng model na ito.",
    features: {
      dynamicMemory: "Dynamic Memory",
      companionSoulWriter: "Tagasulat ng Companion Soul",
  ...
  samplerOrder: {
    ...
    stages: {
      ...
      adaptiveP: {
        label: "Adaptive-P",
        desc: "Pumipili ng mga token na malapit sa target na probabilidad at umaangkop sa paglipas ng panahon. Laging huling tumatakbo, at kapag nakatakda lang ang target nito.",
      },
    },
    presets: {
      default: {
  ...
  editPrompt: {
    ...
    conditions: {
      ...
      isLocalImageGenerationModel: "Lokal na modelo ng pagbuo ng larawan",
      isSceneGenerationLocalImageModel: "Gumagamit ang pagbuo ng eksena ng lokal na modelo ng larawan",
      hasScene: "May scene",
    ...
    describe: {
      ...
      localImageGenerationModel: "lokal ang modelo ng pagbuo ng larawan",
      sceneGenerationLocalImageModel: "gumagamit ang pagbuo ng eksena ng lokal na modelo ng larawan",
      sceneGenerationRemoteImageModel: "gumagamit ang pagbuo ng eksena ng remote na modelo ng larawan",
      remoteImageGenerationModel: "hindi lokal ang modelo ng pagbuo ng larawan",
  ...
  usageAnalytics: {
    page: {
      ...
      nanoGpt: {
        tab: "NANOGPT",
        subtitle: "Quota at paggamit ng subscription mula sa provider",
        account: "NanoGPT account",
        noAccount: "Walang naka-configure na NanoGPT account",
        noAccountDescription: "Magdagdag ng NanoGPT provider na may API key para makuha ang paggamit ng subscription.",
        fetchFailed: "Hindi makuha ang paggamit ng NanoGPT",
        noQuota: "Walang ibinalik na quota period",
        noQuotaDescription: "Matagumpay na tumugon ang NanoGPT pero walang weekly, daily, o monthly quota data.",
        authoritative: "Direktang iniulat ng NanoGPT. Hindi ginagamit dito ang lokal na chat records.",
        weekly: "Lingguhang quota",
        daily: "Arawang quota",
        monthly: "Buwanang quota",
        used: "nagamit",
        consumed: "Nagamit",
        remaining: "Natitira",
        limit: "Quota",
        ...
        warningInfo: "Regular na sinusuri ng LettuceAI ang mga NanoGPT account at nagbababala sa 75%, 90%, at 100%. Isang beses lang ipinapakita ang bawat babala kada period.",
        warningTitle: "Nasa {{percent}}% ang NanoGPT quota",
        warningDescription: "May {{remaining}} pang natitira sa {{account}}. Magre-reset sa {{reset}}.",
        warningDescriptionNoReset: "May {{remaining}} pang natitira sa {{account}}.",
        localTitle: "Lokal na aktibidad",
        localSubtitle: "Naitala ng LettuceAI para sa mga NanoGPT request. Hiwalay itong binibilang mula sa quota sa itaas.",
        localWindowQuota: "Ang quota window na ito",
        localWindow30d: "Huling 30 araw",
        localWindowAll: "Lahat ng oras",
        localRequests: "Mga Kahilingan",
        localTokens: "Mga Token",
        localCost: "Gastos",
        localAvgTokens: "Avg na token / kahilingan",
        localEmpty: "Walang naitalang NanoGPT request sa saklaw na ito.",
        localViewSummary: "Buod",
        localViewList: "Listahan ng kahilingan",
        localShowMore: "Magpakita ng {{count}} pa",
        localFailed: "{{count}} ang bigo",
      },
      today: "Ngayon",
      last7Days: "7 Araw",
      last30Days: "30 Araw",
  ...
  pageHeader: {
    clearSearch: "Burahin ang paghahanap",
    searchChats: "Maghanap ng mga chat",
    searchGroups: "Maghanap ng mga group chat",
    searchLibrary: "Maghanap sa library",
    results: "{{count}} sa {{total}}",
    noResultsTitle: "Walang tugma",
    noResultsBody: "Walang tugma dito sa \"{{query}}\".",
  },
};
