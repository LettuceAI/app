...
export const idMessages: DeepPartialMessageTree<LocaleMessages> = {
  ...
  characters: {
    ...
    conflicts: {
      title: "Perlu ditinjau", reviewTitle: "Beberapa perubahan memerlukan keputusan Anda",
      ...
      fieldsDiffer: "{{count}} bidang berbeda", currentVersion: "Versi saat ini",
      otherVersion: "Versi lain", device: "Perangkat {{id}}", detected: "Terdeteksi {{date}}",
      emptyValue: "Kosong", keepCurrent: "Pertahankan saat ini", useOther: "Gunakan versi lain",
      loadError: "Detail konflik tidak dapat dimuat.", resolveError: "Pilihan tidak dapat disimpan. Tidak ada yang diubah.",
      entities: { item: "Item", character: "Karakter", persona: "Persona", lorebook: "Buku lore", lorebookEntry: "Entri buku lore", promptTemplate: "Templat prompt" },
      fields: {
        changedValue: "Nilai yang berubah", name: "Nama", nickname: "Nama panggilan", title: "Judul",
        description: "Deskripsi", definition: "Definisi", scenario: "Skenario",
        creatorNotes: "Catatan pembuat", tags: "Tag", systemPrompt: "Prompt sistem",
        keywordDetection: "Deteksi kata kunci", content: "Konten", keywords: "Kata kunci",
        enabled: "Aktif", alwaysActive: "Selalu aktif", priority: "Prioritas", entries: "Entri prompt",
      },
    },
    lorebook: {
      keywords: "KATA KUNCI",
  ...
  hfBrowser: {
    ...
    bundle: {
      ...
      formatHint:
        "Cari repositori yang diterbitkan dalam format ini. Safetensors menjangkau banyak repositori gambar yang tidak pernah merilis build GGUF.",
      ...
      roles: { diffusion: "Model difusi", textEncoder: "Encoder teks", vae: "VAE", visionEncoder: "Encoder visi" },
    },
  ...
  usageAnalytics: {
    page: {
      ...
      nanoGpt: {
        ...
        weekly: "Kuota mingguan", daily: "Kuota harian", monthly: "Kuota bulanan",
        used: "terpakai", consumed: "Digunakan", remaining: "Tersisa", limit: "Kuota", resets: "Direset",
        notReported: "Tidak dilaporkan", active: "Aktif", inactive: "Tidak aktif",
