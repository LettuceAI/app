...
export const idMessages: DeepPartialMessageTree<LocaleMessages> = {
  ...
  accessibility: {
    ...
    navigation: {
      styleTitle: "Gaya bilah navigasi",
      bottom: "Bilah Bawah",
      bottomDesc: "Bilah berisi ikon saja di sepanjang tepi bawah",
      bottomLabels: "Bilah Bawah dengan Label",
      bottomLabelsDesc: "Menambahkan label teks di bawah setiap ikon",
      dock: "Dock Mengambang",
      dockDesc: "Bilah berbentuk pil di tengah, terpisah dari tepi bawah",
      sidebar: "Bilah Samping",
      sidebarDesc: "Deret ikon vertikal yang menempel di tepi jendela",
      floatingSidebar: "Bilah Samping Mengambang",
      floatingSidebarDesc: "Bilah berbentuk pil vertikal, terpisah dari tepi jendela",
      side: "Posisi bilah samping",
      sideDesc: "Tepi tempat bilah samping berada",
      sidebarFallbackNote: "Pada jendela sempit, bilah samping beralih ke gaya bawah.",
      placement: "Penempatan",
      placementDesc: "Letak navigasi di sepanjang tepinya",
      posTop: "Atas",
      posMiddle: "Tengah",
      posBottom: "Bawah",
      posCenter: "Tengah",
      itemsTitle: "Item Navigasi",
      itemsDesc: "Seret untuk mengurutkan ulang. Buat tetap ada di bilah. Berlaku di desktop.",
      itemsReset: "Reset",
      itemsAdd: "Tambah item",
      itemsRemove: "Hapus {{label}}",
      insideHeader: "Di Dalam Header",
      insideHeaderDesc: "Item navigasi diletakkan di tengah header halaman",
      header: "Header",
      headerDesc: "Cara header halaman digambar di halaman utama",
      header_auto: "Samakan dengan navigasi",
      header_attached: "Menempel",
      header_floating: "Mengambang",
      header_inline: "Di halaman",
    },
    language: {
  ...
  components: {
    ...
    avatarGeneration: {
      ...
      localEditingUnavailable: "Pengeditan avatar tidak tersedia dengan model pembuatan gambar lokal.",
      ...
      useThis: "Gunakan Ini",
      queuedWithPosition: "Menunggu dalam antrean (posisi {{position}})",
      loadingModel: "Memuat model...",
      preparing: "Menyiapkan...",
      samplingProgress: "Langkah {{step}} dari {{steps}}",
      finalizing: "Menyelesaikan...",
      retryingWithOffload: "Kehabisan memori. Mencoba lagi dengan offload CPU...",
      cancelGeneration: "Hentikan",
      cancelling: "Menghentikan...",
      paintMask: "Area lukis",
      paintMaskHint: "Area yang dilukis akan dibuat ulang. Sisanya tetap sama.",
      brushSize: "Ukuran kuas",
      clearMask: "Bersihkan",
      upscale: "Perbesar resolusi",
      upscaling: "Memperbesar resolusi gambar...",
      upscaleFailed: "Gagal memperbesar resolusi gambar",
    },
    avatarPosition: {
      title: "Posisi Avatar",
      instructions: "Seret untuk memposisikan • Cubit atau gulir untuk memperbesar",
  ...
  chats: {
    ...
    companionRelationship: {
      ...
      soulGrowthConfidence: "Keyakinan",
      soulGrowthLock: "Kunci fakta ini",
      soulGrowthUnlock: "Buka kunci fakta ini",
      soulGrowthLocked: "Terkunci",
      soulGrowthPolicyHistorical: "Historis",
      soulGrowthPolicyCurrent: "Saat ini",
      soulGrowthPolicyAdaptive: "Adaptif",
    ...
    debugPage: {
      ...
      tokenBreakdown: "Penggunaan Konteks",
      tokenBreakdownEstimate: "Perkiraan — tiktoken o200k (perkiraan; tokenizer milik model sendiri akan berbeda)",
      tokenBreakdownCalibrated: "Rincian",
      tokenBreakdownTotal: "Total prompt",
      tokenBreakdownContext: "Jendela konteks",
      tokenBreakdownFree: "Bebas",
  ...
  groupChats: {
    ...
    overrides: {
      ...
      participantsAndMutedOverridden: "Peserta dan pembisuan diubah untuk obrolan ini",
    },
    memories: {
      tabMemories: "Memori",
    ...
    modelOverrides: {
      ...
      subtitle: "Pilih model berbeda untuk satu karakter",
      loading: "Memuat model...",
      overrideBadge: "Penggantian",
      selectFor: "Model untuk {name}",
      useCharacterDefault: "Gunakan model karakter",
      inheritedValue: "{{model}} (bawaan karakter)",
      missingModel: "Model yang dipilih tidak ditemukan",
      noModel: "Tidak ada model yang dikonfigurasi",
    },
    promptOverride: {
      title: "Prompt sistem grup",
      conversationSubtitle: "Diterapkan pada setiap balasan di grup percakapan ini",
      roleplaySubtitle: "Diterapkan pada setiap balasan di grup roleplay ini",
      useCharacterDefault: "Gunakan prompt masing-masing karakter",
      hint: "Menggantikan prompt grup yang akan dipakai setiap karakter secara sendiri-sendiri.",
    },
  },
  characters: {
    companionSetup: {
    ...
    conflicts: {
      ...
      reviewTitle: "Beberapa perubahan memerlukan keputusan Anda",
      reviewDescription: "Sinkronisasi selesai dengan aman. Pilih versi yang dipertahankan untuk setiap item.",
      waitForSync: "Selesaikan sinkronisasi saat ini sebelum meninjau perubahan ini.",
      fieldsDiffer: "{{count}} bidang berbeda",
      currentVersion: "Versi saat ini",
      otherVersion: "Versi lain",
      device: "Perangkat {{id}}",
      detected: "Terdeteksi {{date}}",
      emptyValue: "Kosong",
      keepCurrent: "Pertahankan saat ini",
      useOther: "Gunakan versi lain",
      loadError: "Detail konflik tidak dapat dimuat.",
      resolveError: "Pilihan tidak dapat disimpan. Tidak ada yang diubah.",
      entities: {
        item: "Item",
        character: "Karakter",
        persona: "Persona",
        lorebook: "Buku lore",
        lorebookEntry: "Entri buku lore",
        promptTemplate: "Templat prompt",
      },
      fields: {
        changedValue: "Nilai yang berubah",
        name: "Nama",
        nickname: "Nama panggilan",
        title: "Judul",
        description: "Deskripsi",
        ...
        keywordDetection: "Deteksi kata kunci",
        content: "Konten",
        keywords: "Kata kunci",
        enabled: "Aktif",
        alwaysActive: "Selalu aktif",
        priority: "Prioritas",
        entries: "Entri prompt",
      },
    },
    lorebook: {
      keywords: "KATA KUNCI",
  ...
  models: {
    ...
    menu: {
      ...
      duplicateDescription: "Buat salinan model ini",
    ...
    toasts: {
      ...
      duplicateSuccessTitle: "Model diduplikasi",
      duplicateSuccessDescription: "{{name}} berhasil dibuat.",
      duplicateFailed: "Gagal menduplikasi",
    },
    downloadQueue: {
  ...
  playground: {
    ...
    title: "Playground",
    back: "Kembali",
    open: "Buka Playground",
    openDescription: "Hasilkan gambar dengan bebas memakai prompt, pengaturan model, dan LoRA.",
    promptTab: "Prompt",
    settingsTab: "Pengaturan",
    emptyFeed: "Belum ada hasil",
    emptyFeedHint: "Tulis prompt lalu tekan Hasilkan.",
    settings: {
      model: "Model",
      pickModel: "Pilih model gambar",
      noModel: "Tidak ada model gambar yang dipilih",
      generation: "Pembuatan",
      size: "Ukuran",
      sizePlaceholder: "mis. 1024x1024",
      steps: "Langkah",
      cfg: "CFG Scale",
      sampler: "Sampler",
      scheduler: "Penjadwal",
      ...
      hires: "Hires fix",
      hiresUpscaler: "Peningkat resolusi",
      hiresNone: "Tidak ada peningkat resolusi terpasang",
      hiresScale: "Skala",
      hiresSteps: "Langkah hires",
      hiresDenoising: "Denoising",
    },
    loras: {
      title: "LoRA",
      add: "Tambah",
      empty: "Belum ada LoRA yang diterapkan.",
      pickerTitle: "Tambah LoRA",
      none: "Belum ada LoRA di pustaka Anda. Buka Pustaka LoRA untuk mengunduh beberapa.",
      openLibrary: "Buka Pustaka LoRA",
    },
    prompt: {
      label: "Prompt",
      placeholder: "Deskripsikan gambar yang ingin Anda hasilkan...",
      negativeLabel: "Prompt negatif",
      negativePlaceholder: "Hal yang ingin dihindari...",
      generate: "Hasilkan",
      generating: "Menghasilkan...",
      shortcutHint: "Ctrl+Enter untuk menghasilkan",
      initImageLabel: "Gambar ke gambar",
      pickInitImage: "Pilih gambar awal",
      pickInitImageFile: "Dari file",
      pickInitImageHistory: "Dari riwayat",
      pickFromHistory: "Pilih dari hasil Anda",
      noHistoryImages: "Belum ada hasil sebelumnya. Hasilkan beberapa gambar terlebih dahulu.",
      clearInitImage: "Hapus",
      strength: "Kekuatan",
      initImageFailed: "Tidak dapat memuat gambar tersebut",
      initImageSet: "Gambar awal diatur",
    },
    progress: {
      starting: "Memulai",
      loading: "Memuat model",
      ...
      generating: "Menghasilkan",
      sampling: "Sampling",
      retrying: "Mencoba lagi dengan penggunaan memori lebih rendah",
    },
    feed: {
      loadOlder: "Muat hasil lama",
      cancel: "Batalkan pembuatan",
      failed: "Pembuatan gagal",
      cancelled: "Pembuatan dibatalkan",
      interrupted: "Pembuatan terputus",
      delete: "Hapus hasil",
      sendToImg2img: "Gunakan sebagai gambar awal",
      upscale: "Perbesar resolusi",
      upscaleFailed: "Perbesaran resolusi gagal",
      copyPrompt: "Salin prompt",
      promptCopied: "Prompt disalin",
      reuseSeed: "Pakai ulang seed ini",
      seedReused: "Seed diatur ke {{seed}}",
      regenerate: "Hasilkan ulang dengan pengaturan sama",
      modelMissing: "Model tersebut tidak lagi tersedia",
      deleteTitle: "Hapus hasil",
      deleteBody: "Hapus hasil ini dari umpan. Anda bisa menyimpan file gambarnya atau menghapusnya dari disk juga.",
      deleteKeepImages: "Hapus entri, simpan gambar",
      deleteWithImages: "Hapus entri dan gambar",
  ...
  loraLibrary: {
    ...
    importButton: "Impor berkas",
    importSuccess: "LoRA diimpor",
    importFailed: "Impor gagal",
    installedEmpty: "Belum ada LoRA di pustaka Anda",
    installedEmptyHint: "Unduh dari CivitAI atau impor berkas lokal.",
    noKeywords: "Belum ada kata kunci pemicu",
    discover: "Cari kata kunci",
    discoverFailed: "Pencarian kata kunci gagal",
    editKeywords: "Edit kata kunci",
    deleteTitle: "Hapus LoRA",
    deleteMessage: "Hapus {{name}} dari pustaka? Berkas akan dihapus dari disk.",
    deleteConfirm: "Hapus",
    deleteSuccess: "LoRA dihapus",
    deleteFailed: "Penghapusan gagal",
    keywordsTitle: "Kata kunci pemicu",
    keywordsHint: "Satu kata kunci per baris. Kata kunci ditambahkan ke prompt yang memakai LoRA ini.",
    keywordsSave: "Simpan kata kunci",
    keywordsRequired: "Tambahkan setidaknya satu kata kunci pemicu.",
    keywordsSaveFailed: "Gagal menyimpan kata kunci",
    searchPlaceholder: "Cari LoRA di CivitAI...",
    sortTitle: "Urutkan hasil",
    sortHighestRated: "Penilaian tertinggi",
    sortMostDownloaded: "Paling banyak diunduh",
    sortNewest: "Terbaru",
    periodTitle: "Rentang waktu",
    periodAllTime: "Sepanjang waktu",
    periodYear: "Setahun terakhir",
    periodMonth: "Sebulan terakhir",
    periodWeek: "Seminggu terakhir",
    periodDay: "Hari ini",
    baseModelAll: "Semua model dasar",
    pureModeNote: "Mode Pure aktif. Hanya hasil aman yang ditampilkan.",
    noResults: "LoRA tidak ditemukan",
    noResultsHint: "Coba kata pencarian lain.",
    loadMore: "Muat lebih banyak",
    by: "oleh {{name}}",
    showImage: "Tampilkan gambar",
    backToResults: "Kembali ke hasil",
    backToCaller: "Kembali",
    copyLink: "Salin tautan CivitAI",
    alwaysActive: "Selalu aktif, tanpa kata kunci pemicu",
    copied: "Disalin ke papan klip",
    versions: "Versi",
    triggerWords: "Kata pemicu",
    filesTitle: "Berkas",
    noSafeFiles: "Versi ini tidak punya berkas safetensors.",
    primaryFile: "Utama",
    download: "Unduh",
    downloaded: "Ada di pustaka",
    downloadQueued: "Unduhan masuk antrean",
    downloadFailed: "Unduhan gagal",
    detailLoadFailed: "Tidak dapat memuat model ini.",
    openLibrary: "Buka pustaka LoRA",
    openLibraryDescription: "Jelajahi dan unduh LoRA. Perubahan model yang belum disimpan akan hilang.",
    tokenTitle: "Token API CivitAI",
    tokenBody: "Tambahkan token API CivitAI untuk mengunduh berkas terbatas atau akses awal.",
    tokenGetOne: "Dapatkan token di CivitAI",
    ...
    tokenAdd: "Tambah token",
    tokenReplace: "Ganti token",
    tokenRemove: "Hapus token",
    tokenPrivacy: "Token disimpan secara lokal dan hanya dikirim ke CivitAI.",
  },
  hfAuth: {
  ...
  hfBrowser: {
    filterUnfiltered: "Hasil tanpa filter",
    filterUnfilteredHint: "Cari semua repositori tanpa filter format atau kategori. Berguna untuk berkas komponen seperti VAE dan text encoder yang tidak diberi tag.",
    ...
    modeLlm: "LLM",
    modeImage: "Gambar",
    destinationLlamaCpp: "llama.cpp lokal",
    destinationLocalImage: "Gambar Lokal",
    destinationSelectDownload: "Pilih & Unduh",
    bundle: {
      title: "Buat model gambar",
      subtitle: "Pilih arsitektur dan komponen yang kompatibel. LettuceAI mengunci revisi, memverifikasi, mengunduh, dan mendaftarkan seluruh bundel.",
      verifiedInstaller: "Pemasang bundel terverifikasi",
      chooseArchitecture: "Pilih resep arsitektur",
      changeArchitecture: "Ubah arsitektur",
      formatLabel: "Format",
      formatGguf: "GGUF",
      formatSafetensors: "Safetensors",
      formatHint: "Cari repositori yang diterbitkan dalam format ini. Safetensors menjangkau banyak repositori gambar yang tidak pernah merilis build GGUF.",
      changeProfileConfirm: "Mengubah arsitektur akan menghapus pilihan yang tidak kompatibel. Lanjutkan?",
      componentStep: "Komponen {{current}} dari {{total}}",
      selectRole: "Pilih {{role}}",
      repositoryPlaceholder: "penulis/repository atau URL Hugging Face",
      searchPlaceholder: "Cari repository yang kompatibel atau tempel URL Hugging Face",
      selectFile: "Pilih",
      selectFileHeading: "Pilih file {{role}}",
      compatibleFiles: "{{count}} file kompatibel",
      noCompatibleFiles: "Tidak ada file {{role}} yang kompatibel di repository ini.",
      noCompatibleRepositories: "Tidak ada repository kompatibel untuk komponen ini. Coba pencarian lain atau tempel URL repository.",
      recommendedPrefilled: "Menampilkan repository yang direkomendasikan untuk komponen ini.",
      reviewTitle: "Tinjau dan unduh",
      addToken: "Tambahkan token Hugging Face",
      authHint: "Repository ini mungkin memerlukan token Hugging Face atau persetujuan lisensinya.",
      selectionInvalid: "Pilihan {{role}} tidak dapat dipulihkan. Pilih lagi.",
      gated: "Akses terbatas",
      hfAccess: "Akses Hugging Face",
      tokenPlaceholder: "Token akses Hugging Face",
      saveToken: "Simpan token",
      tokenPrivacy: "Token divalidasi sebelum disimpan dan tidak pernah dikembalikan ke antarmuka atau dimasukkan ke URL unduhan.",
      authInvalid: "Autentikasi Hugging Face gagal",
      textToImage: "Teks ke gambar",
      imageEditing: "Penyuntingan gambar",
      displayName: "Nama tampilan model",
      preDownloadEstimate: "Perkiraan kemampuan jalan sebelum unduh",
      runtimeRequired: "Pasang dan pilih engine stable-diffusion.cpp yang kompatibel di pengaturan Gambar Lokal sebelum mengunduh.",
      calculating: "Menghitung penempatan dengan kebijakan komputasi tersimpan…",
      bundleSize: "Ukuran bundel",
      placement: "Penempatan",
      devices: "Perangkat",
      planConcurrent: "Serentak",
      planTimeShare: "Bertahap",
      planDefaultBackend: "Backend bawaan",
      placementHeading: "Penempatan komponen",
      componentDit: "Inti difusi",
      componentVae: "VAE",
      componentConditioner: "Encoder teks",
      splitAcross: "Dibagi antar perangkat",
      reserve: "cadangan",
      deviceUsable: "{{free}} kosong · {{budget}} dapat dipakai dari {{total}}",
      availableRam: "{{value}} RAM sistem tersedia",
      downloadCreate: "Unduh dan buat model",
      queueFailed: "Tidak dapat memulai unduhan bundel gambar",
      verifying: "Memverifikasi",
      registrationFailed: "Pembuatan model gagal",
      retryRegistration: "Coba buat model lagi",
      retryDownloads: "Coba lagi unduhan yang belum selesai",
      completeTitle: "Model gambar siap",
      completeBody: "{{name}} telah diverifikasi, didaftarkan, dan tersedia di pemilih gambar.",
      openModel: "Buka model",
      steps: "langkah",
      manageEngine: "Kelola engine stable-diffusion.cpp",
      roles: {
        diffusion: "Model difusi",
        textEncoder: "Encoder teks",
        vae: "VAE",
        visionEncoder: "Encoder visi",
      },
    },
  ...
  imageGeneration: {
    ...
    local: {
      sectionTitle: "Model gambar lokal",
      managedTitle: "stable-diffusion.cpp terkelola",
      managedDescription: "Instal model pilihan dan build mesin mandiri. Mesin menghentikan pembuatan teks lokal sebelum memakai akselerator agar kedua beban kerja tidak berebut memori GPU.",
      refreshBuilds: "Segarkan build mesin",
      modelVariant: "Varian model",
      engineVersion: "Versi mesin",
      computeBackend: "Backend komputasi",
      latest: "terbaru",
      installSelected: "Instal pilihan",
      installQueued: "Model gambar lokal masuk antrean",
      sceneReady: "Referensi adegan",
      textToImage: "Teks ke gambar",
      referenceCount: "Hingga {{count}} referensi",
      loraReady: "LoRA",
      fitResolution: "Resolusi pengujian",
      fitReferences: "Referensi",
      testExactFit: "Uji eksekusi nyata",
      fitTestDescription: "Pengujian melepas pembuatan teks lokal dan menjalankan graf sd.cpp satu langkah yang sebenarnya. Tidak ada perkiraan VRAM yang digunakan.",
      ...
      upscaler: {
        title: "Peningkat resolusi",
        description: "Model ESRGAN ({{size}}) yang dipakai untuk aksi Perbesar resolusi dan tahap resolusi tinggi.",
        installed: "Terpasang",
        install: "Pasang",
      },
      engineManager: {
        title: "Engine Stable Diffusion",
        description: "Pasang dan pilih build stable-diffusion.cpp yang dipakai untuk pembuatan gambar lokal.",
        installedTitle: "Versi Terpasang",
        notInstalled: "Engine Belum Terpasang",
        notInstalledBody: "Pasang satu versi engine sebelum menyiapkan model gambar lokal.",
        active: "Aktif",
        useVersion: "Gunakan Versi Ini",
        deleteVersion: "Hapus {{version}}",
        deleteConfirmTitle: "Hapus {{version}}?",
        deleteConfirm: "Ini menghapus build engine ini dari disk.",
        deleteActiveConfirm: "Ini adalah build yang aktif. Versi terpasang lain akan dipilih otomatis, jika tersedia.",
        addVersion: "Pasang Versi Lain",
        installTitle: "Pasang Engine",
        version: "Versi",
        variant: "Varian Build",
        recommended: "Direkomendasikan",
        detectedGpu: "{{device}} terdeteksi. Build kompatibel terbaik dipilih otomatis.",
        noDiscreteGpu: "Tidak ada GPU diskret yang terdeteksi. Build kompatibel teraman telah dipilih.",
        manualVariant: "Dipilih manual. {{backend}} direkomendasikan untuk perangkat ini.",
        install: "Pasang Engine",
        alreadyInstalled: "Sudah Terpasang",
        installing: "Memasang engine",
        queued: "Unduhan engine masuk antrean",
        downloads: "Unduhan Engine",
        cancelDownload: "Batalkan unduhan engine",
        installComplete: "Terpasang dan siap",
        installFailed: "Pemasangan engine gagal",
        switchFailed: "Tidak dapat mengganti versi engine",
        deleteFailed: "Tidak dapat menghapus versi engine",
        inventoryFailed: "Versi engine terpasang tidak dapat dibaca",
        catalogFailed: "Versi engine yang tersedia tidak dapat dimuat",
        computePolicyTitle: "Kebijakan GPU",
        computePolicyDescription: "Pilih GPU mana yang boleh dipakai engine ini dan bagaimana Stable Diffusion membagi kerja model di antaranya.",
        computePolicyConfigure: "Konfigurasi",
        computePolicyLoading: "Membaca GPU yang kompatibel...",
        computePolicySave: "Simpan Kebijakan GPU",
        computePolicySaved: "Kebijakan GPU disimpan",
        computePolicySaveFailed: "Tidak dapat menyimpan kebijakan GPU",
        computeMode: "Pemilihan perangkat",
        computeModeAuto: "Otomatis",
        computeModeAutoDescription: "Biarkan stable-diffusion.cpp memilih penempatan GPU terbaik yang memenuhi syarat untuk setiap model.",
        computeModeSingle: "GPU Tunggal",
        computeModeSingleDescription: "Pertahankan semua kerja GPU pada satu perangkat yang dipilih.",
        computeModeMulti: "Beberapa GPU",
        computeModeMultiDescription: "Gunakan dua perangkat terpilih atau lebih saat model diuntungkan oleh pembagian.",
        eligibleGpus: "GPU yang memenuhi syarat",
        noEligibleGpus: "Tidak ada GPU diskret kompatibel yang tersedia untuk build engine ini.",
        vramBudget: "Anggaran VRAM",
        vramBudgetAuto: "Otomatis",
        vramBudgetHint: "{{available}} saat ini kosong; biarkan kosong untuk otomatis.",
        vramBudgetFor: "Anggaran VRAM untuk {{device}}",
        splitMode: "Pembagian multi-GPU",
        splitLayer: "Pembagian lapisan",
        splitLayerDescription: "Bagikan lapisan model utuh di antara GPU.",
        splitRow: "Pembagian baris",
        splitRowDescription: "Bagi baris tensor individual di antara GPU CUDA.",
        rowCudaOnly: "Pembagian baris membutuhkan build engine CUDA.",
        computeSummaryAuto: "Otomatis · {{count}} GPU memenuhi syarat",
        computeSummarySingle: "GPU tunggal · {{device}}",
        computeSummaryMulti: "Beberapa GPU · {{count}} dipilih",
      },
      modelLibrary: {
        title: "Model",
        description: "Unduh model untuk menghasilkan gambar secara lokal di perangkat ini.",
        refreshHardware: "Segarkan perangkat keras",
        refreshingHardware: "Memeriksa ulang...",
        refreshHardwareDescription: "Baca ulang memori GPU dan hitung ulang kecocokan perangkat keras untuk varian model yang terlihat.",
        refreshFailed: "Tidak dapat menyegarkan informasi perangkat keras model",
        variant: "Varian",
        download: "Unduh",
        installing: "Mengunduh",
        installedShort: "Terpasang",
        needsReference: "Membutuhkan gambar referensi untuk menghasilkan.",
        engineNeededForFit: "Pasang build engine di atas sebelum mengunduh model atau memeriksa kecocokan perangkat keras.",
        noRuntime: "Pasang build engine Stable Diffusion sebelum mengunduh model ini.",
        engineRequired: "Pasang engine dulu",
        engineUpdateRequired: "Membutuhkan build engine {{build}} atau yang lebih baru",
        updateEngineFirst: "Perbarui engine dulu",
        fitChecking: "Memeriksa kecocokan perangkat keras...",
        fitFitsGpu: "Muat di GPU Anda",
        fitPhased: "Muat di GPU Anda, dimuat bertahap",
        fitCpuOffload: "Berjalan dengan offload CPU, lebih lambat",
        fitInconclusive: "Kecocokan perangkat keras tidak diketahui",
        fitVerified: "Terverifikasi pada perangkat keras Anda",
        fitFailed: "Tidak berjalan pada perangkat keras Anda",
        more: "Selengkapnya",
        memorySummary: "Ringkasan memori",
        modelWeights: "File bobot model",
        gpuPlacedWeights: "Ditempatkan di GPU",
        cpuOffloadedWeights: "Dioffload ke CPU",
        availableRam: "RAM tersedia",
        strategy: "Strategi",
        planConcurrent: "GPU serentak",
        planTimeShare: "GPU, dimuat bertahap",
        planDefaultBackend: "Cadangan CPU",
        deviceMemory: "Memori GPU",
        freeMemory: "Kosong",
        usableBudget: "Anggaran yang dapat dipakai",
        noGpuPlacement: "Tidak ada penempatan GPU diskret yang tersedia untuk rencana ini.",
        componentPlacement: "Penempatan komponen",
        weights: "Bobot",
        computeReserve: "Cadangan komputasi",
        singleGpuNeed: "Kebutuhan GPU tunggal",
        split: "dibagi",
        offloadConfirmTitle: "Unduh {{model}}?",
        offloadConfirm: "Model ini tidak muat di GPU Anda dan akan dioffload ke CPU serta RAM sistem, sehingga pembuatan gambar akan lambat. Tetap unduh?",
        modelCard: "Kartu model",
        queued: "Unduhan model masuk antrean",
        installFailed: "Unduhan model gagal",
        uninstallFailed: "Tidak dapat menghapus model",
        uninstallModel: "Hapus {{model}}",
        uninstallConfirmTitle: "Hapus {{model}}?",
        uninstallConfirm: "Ini menghapus bobot model dari disk. Komponen bersama yang dipakai model terpasang lain tetap disimpan.",
        familyModelCount: "{{count}} model",
        familyModelCountOne: "1 model",
        familyInstalledCount: "{{count}} terpasang",
      },
      entryCard: {
        manage: "Kelola",
      },
      hub: {
        unsupportedTitle: "Tidak didukung di sistem ini",
        desktopOnlyTitle: "Hanya desktop",
        desktopOnlyBody: "Engine Stable Diffusion tersedia di aplikasi desktop.",
      },
    },
  },
  logs: {
  ...
  sync: {
    ...
    progress: {
      ...
      phases: {
        ...
        separatingChatBranches: "Memisahkan cabang obrolan bersamaan",
        waitingForDatabase: "Menunggu basis data lokal",
        comparingFiles: "Membandingkan file",
        exchangingFiles: "Bertukar file",
      },
      databaseWait: {
        title: "Basis data lokal sedang sibuk",
        description: "Tugas lain sedang menyelesaikan penulisan basis data. Sinkronisasi dijeda dengan aman dan akan mencoba lagi secara otomatis.",
        retry: "Percobaan {{current}} dari {{total}} dalam {{delay}}",
      },
    },
  ...
  sessionAdvanced: {
    ...
    samplingMemory: {
      ...
      stable: "Stabil",
      reasoning: "Penalaran",
      adaptiveTarget: "Target Adaptive-P",
      adaptiveTargetDesc: "Bidik token di sekitar probabilitas ini. Kosong mempertahankan sampling normal.",
      adaptiveDecay: "Peluruhan Target Adaptive-P",
      adaptiveDecayDesc: "Seberapa stabil adaptasi target. Lebih rendah bereaksi lebih cepat.",
    },
    systemInfo: {
      title: "Info Sistem",
  ...
  featureGeneration: {
    ...
    tabTitle: "Fitur",
    tabDescription: "Konfigurasikan cara setiap fitur aplikasi melakukan sampling saat menggunakan model ini. Kolom yang kosong mewarisi dari pengaturan generasi model ini.",
    features: {
      dynamicMemory: "Memori Dinamis",
      companionSoulWriter: "Penulis Jiwa Companion",
  ...
  samplerOrder: {
    ...
    stages: {
      ...
      adaptiveP: {
        label: "Adaptive-P",
        desc: "Memilih token di sekitar probabilitas target dan beradaptasi seiring waktu. Selalu dijalankan terakhir, dan hanya saat targetnya diatur.",
      },
    },
    presets: {
      default: {
  ...
  editPrompt: {
    ...
    describe: {
      ...
      localImageGenerationModel: "model pembuatan gambar bersifat lokal",
      sceneGenerationLocalImageModel: "pembuatan adegan menggunakan model gambar lokal",
      sceneGenerationRemoteImageModel: "pembuatan adegan menggunakan model gambar jarak jauh",
      remoteImageGenerationModel: "model pembuatan gambar tidak bersifat lokal",
    ...
    conditions: {
      ...
      isLocalImageGenerationModel: "Model pembuatan gambar lokal",
      isSceneGenerationLocalImageModel: "Pembuatan adegan menggunakan model gambar lokal",
  ...
  editModel: {
    setup: {
      ...
      sdcppManaged: "Pilih dari model yang terpasang di perangkat ini. Entri dan filenya dikelola secara otomatis.",
      sdcppSelectModel: "Pilih model terpasang",
      sdcppCustomHelp: "Arahkan ke file GGUF model utama di disk, lalu atur file encoder teks dan VAE-nya di tab Konfigurasi.",
    },
    errors: {
    ...
    sdcpp: {
      baseLoras: "LoRA Dasar",
      baseLorasDescription: "LoRA ini dimuat pada setiap pembuatan dengan model ini. LoRA karakter dan gaya diterapkan di atasnya.",
      addLora: "Tambah LoRA",
      noBaseLoras: "Belum ada LoRA tingkat model yang dikonfigurasi",
      chooseLora: "Pilih LoRA",
      loraPath: "Lokasi LoRA",
      strength: "Kekuatan",
      loraKeywords: "Kata kunci pemicu",
      loraKeywordsDescription: "Ditambahkan otomatis saat LoRA ini aktif",
      editKeywords: "Edit kata kunci",
      keywordsRequired: "Tambahkan kata kunci LoRA",
      keywordsRequiredDescription: "Tambahkan setidaknya satu kata kunci pemicu sebelum menyimpan model ini.",
      loraAlwaysActive: "Selalu aktif, tanpa kata kunci pemicu",
      markLoraAlwaysActive: "LoRA ini tidak butuh kata kunci, tandai sebagai selalu aktif",
      keywordEditorTitle: "Kata kunci LoRA",
      keywordEditorDescription: "Masukkan satu kata kunci per baris atau pisahkan dengan koma. Nilai yang ditemukan otomatis tetap dapat diedit.",
      ...
      removeIncompatibleLora: "Hapus LoRA yang tidak kompatibel sebelum menyimpan model ini.",
      loraCompatibilityUnknown: "Kompatibilitas tidak diketahui",
      loraCompatibilityUnknownDescription: "LoRA tidak mencantumkan arsitektur dasar yang tepat. Anda dapat mencobanya, tetapi kompatibilitas tidak dijamin.",
      removeLora: "Hapus LoRA",
      installedFiles: "File terinstal",
      installedFilesDescription: "Lokasi model dan komponen terkelola yang saat ini dikirim ke stable-diffusion.cpp.",
      modelPath: "Lokasi model",
      textEncoderPath: "Lokasi encoder teks",
      visionEncoderPath: "Lokasi encoder visual",
      vaePath: "Lokasi VAE",
      noInstalledFiles: "Pilih model gambar lokal yang terinstal untuk melihat filenya.",
      loraFiles: "File LoRA",
      modelFilesFilter: "Berkas model difusi",
      importLora: "Impor file LoRA",
      importLoraDescription: "Salin LoRA ke pustaka pembuatan gambar lokal",
      importFailed: "Impor LoRA gagal",
      modelFiles: "File model",
      modelFilesDescription: "File yang diteruskan model ini ke stable-diffusion.cpp. Lokasi model utama di atas adalah GGUF difusi; encoder teks dan VAE wajib ada untuk berjalan, sedangkan encoder visual hanya berlaku untuk model penyuntingan gambar.",
      textEncoder: "Encoder teks",
      vae: "VAE",
      visionEncoder: "Encoder visual",
      optionalFile: "opsional",
      modelFilesIncomplete: "Atur file encoder teks dan VAE. Pembuatan gambar tidak akan dimulai sampai model ini dikonfigurasi sepenuhnya.",
      detectedArchitecture: "Arsitektur terdeteksi: {{name}}",
      detectFailed: "Tidak dapat mendeteksi arsitektur file ini. Atur file komponen secara manual.",
      componentsRequiredTitle: "File model tidak lengkap",
      componentsRequiredBody: "Isi file komponen yang disorot sebelum menyimpan.",
      componentFilesFilter: "File komponen model",
      chooseFromLibrary: "Pilih dari Pustaka",
      componentPickerTitle: "Pilih File Komponen",
      componentLibraryEmpty: "Tidak ada file yang cocok di pustaka Anda",
      componentLibraryEmptyHint: "Pasang model gambar lokal atau unduh file encoder dengan penjelajah model terlebih dahulu.",
      sourceImageComponents: "Komponen gambar",
      sourceLlmLibrary: "Pustaka LLM",
      sourceImageDownloads: "File terunduh",
    },
    modelSource: {
    ...
    generationAdvanced: {
      title: "Generasi lanjutan",
      description: "Sampling, ubin VAE, referensi, dan tahap resolusi tinggi",
      modelDefault: "Bawaan model",
      sampler: "Sampler",
      scheduler: "Penjadwal",
      schedulerDescription: "Jadwal noise yang digunakan selama langkah sampling",
      imageGuidance: "CFG gambar",
      imageGuidanceDescription: "Kekuatan panduan untuk gambar referensi",
      distilledGuidance: "Panduan terdistilasi",
      distilledGuidanceDescription: "Panduan khusus untuk arsitektur terdistilasi",
      samplingSection: "Sampling",
      eta: "Eta",
      etaDescription: "Noise stokastik untuk sampler yang kompatibel",
      flowShift: "Pergeseran aliran",
      flowShiftDescription: "Pergeseran timestep untuk model berbasis aliran",
      vaeSection: "Ubin VAE",
      vaeTiling: "Gunakan ubin VAE",
      vaeTilingDescription: "Dekode gambar per ubin untuk mengurangi puncak memori",
      tileWidth: "Lebar ubin",
      tileHeight: "Tinggi ubin",
      tileOverlap: "Tumpang tindih ubin",
      referencesSection: "Gambar referensi",
      autoResizeReferences: "Ubah ukuran referensi otomatis",
      autoResizeReferencesDescription: "Sesuaikan referensi dengan ukuran generasi",
      increaseReferenceIndex: "Naikkan indeks referensi",
      increaseReferenceIndexDescription: "Beri setiap referensi indeks posisi tersendiri",
      hiresSection: "Tahap resolusi tinggi",
      hiresFix: "Aktifkan tahap resolusi tinggi",
      hiresFixDescription: "Perbesar dan sempurnakan hasil pertama pada tahap kedua",
      upscaler: "Peningkat resolusi",
      scale: "Skala",
      targetWidth: "Lebar target",
      targetHeight: "Tinggi target",
      secondPassSteps: "Langkah tahap kedua",
      denoisingStrength: "Kekuatan denoising",
      stepCaching: "Cache langkah",
      stepCachingDescription: "Gunakan ulang langkah difusi yang mirip untuk mempercepat pembuatan dengan sedikit penurunan kualitas",
      cacheMode: "Mode cache",
      cacheModeDisabled: "Dinonaktifkan",
      cacheOption: "Penyetelan cache",
      cacheOptionPlaceholder: "threshold=0.2, start=0.15",
      slgSection: "Panduan lewati lapisan",
      slgSectionDescription: "Memandu sampling dengan melewati lapisan transformer. Biarkan skala kosong untuk mematikannya.",
      slgScale: "Skala panduan",
      slgDisabled: "Mati",
      slgLayers: "Lapisan yang dilewati",
      slgLayerStart: "Fraksi awal",
      slgLayerEnd: "Fraksi akhir",
    },
    generationDescriptions: {
      ...
      sdSampler: "Sampler difusi yang digunakan mesin gambar",
      sdSeed: "Leave blank for random generations",
      sdDenoise: "Edit strength for reference-based generations",
      sdNegativePrompt: "Diterapkan ke setiap permintaan gambar untuk model ini",
    ...
    moveModel: {
      ...
      moveAllTitle: "Simpan File di Pustaka",
      moveAllDescription: "Pindahkan model ini beserta file draft dan visinya ke folder pustaka GGUF LettuceAI.",
      moveAllAction: "Pindahkan ke pustaka",
      moveAllMoving: "Memindahkan file...",
      moveAllDone: "Semua file sudah ada di pustaka",
      movedAllTitle: "File dipindahkan",
      movedAllBody: "Model ini beserta file pendampingnya kini berada di pustaka GGUF.",
    },
    parameterSupport: {
    ...
    llamaSampler: {
      ...
      adaptiveTarget: "Target Adaptive-P",
      adaptiveTargetDescription: "Probabilitas target untuk Adaptive-P; biarkan kosong untuk mempertahankan langkah sampling akhir standar",
      adaptiveDecay: "Peluruhan Target Adaptive-P",
      adaptiveDecayDescription: "Nilai lebih rendah bereaksi lebih cepat pada token terbaru, lebih tinggi lebih stabil",
    },
    mtp: {
    ...
    dflash: {
      title: "Speculative Decoding DFlash",
      description: "Membuat draft satu blok token penuh per langkah menggunakan file draft DFlash. Diprioritaskan di atas MTP saat file draft tersedia.",
      toggle: "Alihkan speculative decoding DFlash",
      visionWarningTitle: "DFlash tidak tersedia untuk vision",
      visionWarningDescription: "Permintaan gambar akan dilanjutkan tanpa DFlash selama file vision MMProj dikonfigurasi.",
      placement: "Penempatan Model Draft",
      placementDescription: "Auto menggunakan GPU tercepat yang memiliki ruang cukup",
      placementGpu: "GPU",
      placementCpu: "CPU",
      draftTokens: "Draft Tokens",
      draftTokensDescription: "Token yang didraft per blok, dibatasi ukuran blok yang dilatih pada file draft (1 hingga 15)",
      minProbability: "Keyakinan Minimum",
      minProbabilityDescription: "Pendraftan berhenti pada token pertama di bawah keyakinan ini (0 hingga 1)",
      draftFile: "File Draft DFlash",
      draftFileDescription: "GGUF draft DFlash yang dilatih untuk model ini. Ditemukan otomatis dari *dflash*.gguf sejajar saat kosong.",
      draftFilePlaceholder: "Temukan otomatis",
    },
  },
  usageAnalytics: {
    page: {
      ...
      nanoGpt: {
        tab: "NANOGPT",
        subtitle: "Kuota dan penggunaan langganan yang dilaporkan penyedia",
        account: "Akun NanoGPT",
        noAccount: "Belum ada akun NanoGPT",
        noAccountDescription: "Tambahkan penyedia NanoGPT dengan kunci API untuk mengambil penggunaan langganan.",
        fetchFailed: "Tidak dapat mengambil penggunaan NanoGPT",
        noQuota: "Tidak ada periode kuota yang dikembalikan",
        noQuotaDescription: "NanoGPT merespons dengan sukses, tetapi tidak menyertakan data kuota mingguan, harian, atau bulanan.",
        authoritative: "Dilaporkan langsung oleh NanoGPT. Catatan chat lokal tidak digunakan di sini.",
        weekly: "Kuota mingguan",
        daily: "Kuota harian",
        monthly: "Kuota bulanan",
        used: "terpakai",
        consumed: "Digunakan",
        remaining: "Tersisa",
        limit: "Kuota",
        ...
        warningInfo: "LettuceAI memeriksa akun NanoGPT secara berkala dan memberi peringatan pada 75%, 90%, dan 100%. Setiap peringatan tampil sekali per periode.",
        warningTitle: "Kuota NanoGPT mencapai {{percent}}%",
        warningDescription: "{{account}} memiliki sisa {{remaining}}. Direset {{reset}}.",
        warningDescriptionNoReset: "{{account}} memiliki sisa {{remaining}}.",
        localTitle: "Aktivitas lokal",
        localSubtitle: "Dicatat oleh LettuceAI untuk permintaan NanoGPT. Dihitung terpisah dari kuota di atas.",
        localWindowQuota: "Periode kuota ini",
        localWindow30d: "30 hari terakhir",
        localWindowAll: "Sepanjang waktu",
        localRequests: "Permintaan",
        localTokens: "Token",
        localCost: "Biaya",
        localAvgTokens: "Rata-rata token / permintaan",
        localEmpty: "Tidak ada permintaan NanoGPT yang tercatat pada rentang ini.",
        localViewSummary: "Ringkasan",
        localViewList: "Daftar permintaan",
        localShowMore: "Tampilkan {{count}} lagi",
        localFailed: "{{count}} gagal",
      },
      today: "Hari Ini",
      last7Days: "7 Hari",
      last30Days: "30 Hari",
  ...
  pageHeader: {
    clearSearch: "Bersihkan pencarian",
    searchChats: "Cari obrolan",
    searchGroups: "Cari obrolan grup",
    searchLibrary: "Cari pustaka",
    results: "{{count}} dari {{total}}",
    noResultsTitle: "Tidak ada yang cocok",
    noResultsBody: "Tidak ada yang cocok dengan \"{{query}}\" di sini.",
  },
};
