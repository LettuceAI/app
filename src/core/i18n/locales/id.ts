...
export const idMessages: DeepPartialMessageTree<LocaleMessages> = {
  ...
  tour: {
    ...
    gotIt: "Mengerti",
    appShell: {
      chats: { title: "Di sinilah obrolan Anda berada", body: "Semua percakapan satu-satu Anda dengan karakter ada di sini. Kembali kapan saja dan kami akan menyimpan posisi Anda." },
      groups: { title: "Bergabung di obrolan grup", body: "Bawa beberapa karakter ke dalam satu ruangan dan saksikan mereka saling berbicara, atau ikut kapan pun Anda mau." },
      discover: { title: "Temukan karakter baru", body: "Jelajahi apa yang dibagikan komunitas dan ambil karakter yang menarik perhatian Anda. Favorit baru hanya satu ketukan saja." },
      library: { title: "Perpustakaan pribadi Anda", body: "Semua yang Anda buat atau simpan ada di sini: karakter, persona, prompt, semuanya. Anggap saja ini koleksi Anda." },
      settings: { title: "Sesuaikan sesuka Anda", body: "Ganti penyedia, pilih model berbeda, atur tampilan aplikasi. Hampir semuanya bisa disesuaikan dari pengaturan." },
      search: { title: "Temukan apa saja, cepat", body: "Mencari obrolan atau karakter tertentu? Cari di semua tempat dari sini. Tanpa perlu menggali." },
      create: { title: "Dan akhirnya, buat!", body: "Ketuk tombol plus kapan pun inspirasi datang. Buat karakter baru, persona, atau mulai sesuatu dari awal." },
    },
    chatDetail: {
      chatTitle: { title: "Pengaturan per obrolan", body: "Ketuk nama karakter di atas untuk membuka pengaturan khusus obrolan ini. Persona, tata letak, dan pilihan model berbeda per percakapan." },
      chatMemory: { title: "Apa yang mereka ingat", body: "Ikon otak menunjukkan apa yang karakter Anda ingat tentang percakapan. Ketuk untuk meninjau, mengedit, atau menghapus memori." },
      chatSearch: { title: "Temukan baris itu", body: "Cari hanya di percakapan ini. Bagus untuk menemukan detail dari 200 pesan lalu tanpa menggulir selamanya." },
      chatLorebook: { title: "Entri Lorebook", body: "Fakta tambahan, pembangunan dunia, dan konteks yang dimasukkan ke prompt saat kata kunci tertentu muncul. Contekan karakter Anda." },
      chatPlus: { title: "Lampirkan sesuatu", body: "Masukkan gambar atau buka menu ekstra. Apa pun yang Anda lampirkan akan dikirim bersama pesan berikutnya." },
      chatComposer: { title: "Pesan Anda, giliran Anda", body: "Ketik di sini. Enter mengirim, Shift+Enter menambah baris baru. Tips: tekan lama pesan apa pun di obrolan untuk mengedit, bercabang, atau menghapus." },
      chatSend: { title: "Satu tombol, empat fungsi", body: "Tombol kirim berubah fungsinya tergantung apa yang sedang terjadi:" },
    },
    postFirstMessage: {
      chatRegenerate: { title: "Tidak puas? Regenerasi", body: "Ketuk ikon refresh untuk mendapatkan balasan yang sama sekali baru dari karakter. Setiap regenerasi disimpan sebagai varian yang bisa Anda kunjungi kembali." },
      chatVariants: { title: "Geser antar varian", body: "Setelah regenerasi, Anda akan melihat penghitung varian di bawah pesan. Geser ke kiri atau kanan pada gelembung pesan untuk melihat semua balasan berbeda." },
      chatLongPress: { title: "Ada lebih banyak tersembunyi di sini", body: "Tekan lama pesan apa pun untuk mengedit, menyalin, bercabang, menyematkan, menghapus, atau memutar ulang percakapan. Klik kanan juga berfungsi di desktop." },
    },
    sendButton: {
      continue: { label: "Lanjutkan", desc: "Input kosong. Ketuk di sini untuk mendorong karakter terus berbicara." },
      send: { label: "Kirim", desc: "Anda telah mengetik atau melampirkan sesuatu. Ketuk untuk mengirim." },
      sending: { label: "Mengirim", desc: "Balasan sedang dalam perjalanan. Tombol terkunci." },
      stop: { label: "Berhenti", desc: "Ketuk untuk membatalkan di tengah balasan jika Anda berubah pikiran." },
    },
  },

  sessionAdvanced: {
    title: "Parameter Sesi", subtitle: "Timpa default model untuk percakapan ini",
    goBack: "Kembali", support: "Dukungan", reset: "Reset", save: "Simpan",
    noSessionWarning: "Buka sesi obrolan untuk mengkonfigurasi pengaturan per sesi.",
    overrideDefaults: "Timpa default", overrideDefaultsDesc: "Sesuaikan parameter hanya untuk percakapan ini",
    loadingContextInfo: "Memuat info konteks...",
    sampling: { title: "Sampling", temperature: "Temperature", temperatureDesc: "Mengontrol keacakan. Lebih rendah = lebih deterministik, lebih tinggi = lebih kreatif.", temperaturePrecise: "Presisi", temperatureCreative: "Kreatif", topP: "Top P", topPDesc: "Sampling nukleus. Membatasi token pada probabilitas kumulatif.", topPFocused: "Fokus", topPDiverse: "Beragam", topK: "Top K", topKDesc: "Membatasi sampling ke K token paling mungkin." },
    outputPenalties: { title: "Output & Penalti", maxOutputTokens: "Token Output Maksimal", maxOutputTokensDesc: "Panjang respons maksimal. Auto biarkan model yang memutuskan.", auto: "Auto", custom: "Kustom", frequencyPenalty: "Penalti Frekuensi", frequencyPenaltyDesc: "Mengurangi pengulangan urutan token.", frequencyPenaltyRepeat: "Ulang", frequencyPenaltyVary: "Variasi", presencePenalty: "Penalti Kehadiran", presencePenaltyDesc: "Mendorong eksplorasi topik baru.", presencePenaltyRepeat: "Ulang", presencePenaltyExplore: "Eksplorasi" },
    performance: { title: "Performa", gpuLayers: "Layer GPU", gpuLayersDesc: "Layer yang di-offload ke GPU. 0 = hanya CPU.", threads: "Thread", threadsDesc: "Thread CPU untuk inferensi.", batchThreads: "Thread Batch", batchThreadsDesc: "Thread CPU untuk pemrosesan batch.", batchSize: "Ukuran Batch", batchSizeDesc: "Ukuran potongan pemrosesan prompt.", contextLength: "Panjang Konteks", contextLengthDesc: "Timpa ukuran jendela konteks.", flashAttention: "Flash Attention", flashAttentionDesc: "Optimasi memori GPU.", enabled: "Diaktifkan", disabled: "Dinonaktifkan" },
    samplingMemory: { title: "Sampling & Memori", minP: "Min P", minPDesc: "Ambang batas probabilitas minimum.", typicalP: "Typical P", typicalPDesc: "Ambang batas sampling tipikal.", seed: "Seed", seedDesc: "Seed acak. Kosongkan untuk acak.", ropeBase: "RoPE Base", ropeBaseDesc: "Penimpaan basis frekuensi.", ropeScale: "RoPE Scale", ropeScaleDesc: "Penimpaan skala frekuensi.", kvCacheType: "Tipe KV Cache", kvCacheTypeDesc: "Kuantisasi KV Cache untuk menghemat VRAM.", offloadKqv: "Offload KQV", offloadKqvDesc: "KV Cache & operasi KQV di GPU.", on: "Hidup", off: "Mati", samplerProfile: "Profil Sampler", samplerProfileDesc: "Default yang disetel untuk stabilitas atau penalaran.", balanced: "Seimbang", creative: "Kreatif", stable: "Stabil", reasoning: "Penalaran" },
    systemInfo: { title: "Info Sistem", maxContext: "Konteks Maks", recommended: "Direkomendasikan", availableRam: "RAM Tersedia", availableVram: "VRAM Tersedia", modelSize: "Ukuran Model" },
  },
  ...
  designReference: {
    title: "Referensi desain", description: "Unggah beberapa gambar referensi yang jelas dan satu deskripsi visual kanonik.",
    ...
    addReferences: "Tambah referensi", visualDescription: "Deskripsi visual", draftWithAi: "Draf dengan AI",
    referenceImages: "Gambar referensi", imageAlt: "Referensi desain {{index}}", loading: "Memuat...",
    removeAria: "Hapus referensi desain", noImages: "Belum ada gambar referensi yang dilampirkan",
    ...
    draftMenuTitle: "Draf Desain AI", draftMenuDesc: "Dibuat oleh {{model}} dari avatar dan gambar referensi saat ini.",
    draftMenuNoWriter: "Tambahkan model penulis adegan yang kompatibel sebelum menggunakan pembantu ini.",
    regenerate: "Regenerasi", useThis: "Gunakan Ini",
  },

  samplerOrder: {
    title: "Urutan Sampler", description: "Seret tahapan untuk mengatur ulang. Dieksekusi dari atas ke bawah.",
    reset: "Reset", resetAria: "Reset urutan sampler ke default",
    stages: {
      penalties: { label: "Penalti", desc: "Terapkan penalti frekuensi dan kehadiran sebelum penyaringan." },
      grammar: { label: "Tata Bahasa", desc: "Batasi token saat tata bahasa template obrolan bawaan aktif." },
      topK: { label: "Top K", desc: "Pangkas kumpulan kandidat ke token terkuat." },
      topP: { label: "Top P", desc: "Terapkan penyaringan nukleus pada distribusi yang tersisa." },
      minP: { label: "Min P", desc: "Buang token ekor probabilitas rendah menggunakan lantai minimum." },
      typical: { label: "Typical P", desc: "Pilih token yang secara statistik tipikal dalam distribusi saat ini." },
      temp: { label: "Temperature", desc: "Ratakan atau pertajam distribusi akhir sebelum pemilihan." },
    },
    presets: {
      default: { label: "Default", hint: "Lettuce local" },
      unsloth: { label: "Unsloth", hint: "gaya llama.cpp" },
      focused: { label: "Fokus", hint: "Pemangkasan ketat" },
      creative: { label: "Kreatif", hint: "Filter terlambat" },
    },
  },
};
