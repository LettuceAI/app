...
export const frMessages: DeepPartialMessageTree<LocaleMessages> = {
  ...
  characters: {
    ...
    conflicts: {
      ...
      detected: "Détecté le {{date}}", emptyValue: "Vide", keepCurrent: "Garder l’actuelle",
      useOther: "Utiliser l’autre", loadError: "Impossible de charger les détails du conflit.",
      resolveError: "Ce choix n’a pas pu être enregistré. Rien n’a été modifié.",
      entities: { item: "Élément", character: "Personnage", persona: "Persona", lorebook: "Livre de connaissances", lorebookEntry: "Entrée du livre", promptTemplate: "Modèle de prompt" },
      fields: {
        changedValue: "Valeur modifiée", name: "Nom", nickname: "Surnom", title: "Titre",
        description: "Description", definition: "Définition", scenario: "Scénario",
        creatorNotes: "Notes du créateur", tags: "Étiquettes", systemPrompt: "Prompt système",
        keywordDetection: "Détection des mots-clés", content: "Contenu", keywords: "Mots-clés",
        enabled: "Activé", alwaysActive: "Toujours actif", priority: "Priorité", entries: "Entrées du prompt",
      },
    },
    lorebook: {
      keywords: "MOTS-CLÉS",
  ...
  hfBrowser: {
    ...
    bundle: {
      ...
      formatHint:
        "Rechercher les dépôts publiés dans ce format. Safetensors couvre les nombreux dépôts d'images qui ne publient jamais de version GGUF.",
      ...
      roles: { diffusion: "Modèle de diffusion", textEncoder: "Encodeur de texte", vae: "VAE", visionEncoder: "Encodeur de vision" },
    },
    clearSearch: "Effacer la recherche",
    filters: "Filtres",
  ...
  sync: {
    ...
    progress: {
      ...
      stages: { verify: "Vérifier", compare: "Comparer", data: "Données", files: "Fichiers" },
      phases: {
  ...
  usageAnalytics: {
    page: {
      ...
      nanoGpt: {
        ...
        used: "utilisé", consumed: "Consommé", remaining: "Restant", limit: "Quota", resets: "Réinitialisation",
        notReported: "Non indiqué", active: "Actif", inactive: "Inactif",
