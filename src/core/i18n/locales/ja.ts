...
export const jaMessages: DeepPartialMessageTree<LocaleMessages> = {
  ...
  characters: {
    ...
    conflicts: {
      title: "確認が必要", reviewTitle: "判断が必要な編集があります",
      reviewDescription: "同期は安全に完了しました。各項目で保持するバージョンを選択してください。",
      waitForSync: "現在の同期が完了してから編集内容を確認してください。",
      fieldsDiffer: "{{count}} 個の項目が異なります", currentVersion: "現在のバージョン",
      otherVersion: "別のバージョン", device: "デバイス {{id}}", detected: "{{date}} に検出",
      emptyValue: "空", keepCurrent: "現在を保持", useOther: "別の方を使用",
      loadError: "競合の詳細を読み込めませんでした。", resolveError: "選択を保存できませんでした。変更はありません。",
      entities: { item: "項目", character: "キャラクター", persona: "ペルソナ", lorebook: "ロアブック", lorebookEntry: "ロアブック項目", promptTemplate: "プロンプトテンプレート" },
      fields: {
        changedValue: "変更された値", name: "名前", nickname: "ニックネーム", title: "タイトル",
        description: "説明", definition: "定義", scenario: "シナリオ",
        creatorNotes: "作成者メモ", tags: "タグ", systemPrompt: "システムプロンプト",
        keywordDetection: "キーワード検出", content: "内容", keywords: "キーワード",
        enabled: "有効", alwaysActive: "常に有効", priority: "優先度", entries: "プロンプト項目",
      },
    },
    lorebook: {
      keywords: "キーワード",
  ...
  hfBrowser: {
    ...
    bundle: {
      ...
      roles: { diffusion: "拡散モデル", textEncoder: "テキストエンコーダー", vae: "VAE", visionEncoder: "ビジョンエンコーダー" },
    },
    clearSearch: "検索をクリア",
    filters: "フィルター",
  ...
  usageAnalytics: {
    page: {
      ...
      nanoGpt: {
        ...
        weekly: "週間枠", daily: "日次枠", monthly: "月間枠",
        used: "使用済み", consumed: "消費量", remaining: "残り", limit: "上限", resets: "リセット",
        notReported: "報告なし", active: "有効", inactive: "無効",
