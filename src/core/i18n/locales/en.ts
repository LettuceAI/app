...
export const enMessages = {
  ...
  tour: {
    ...
    sendButton: {
      continue: { label: "Continue", desc: "Input empty. Taps here will nudge the character to keep talking." },
      send: { label: "Send", desc: "You've typed or attached something. Tap to send it." },
      sending: { label: "Sending", desc: "Reply is on its way. Button is locked." },
      stop: { label: "Stop", desc: "Tap to cancel mid-reply if you change your mind." },
    },
  },
  ...
  samplerOrder: {
    ...
    stages: {
      penalties: { label: "Penalties", desc: "Apply frequency and presence penalties before filtering." },
      grammar: { label: "Grammar", desc: "Constrain tokens when a native chat template grammar is active." },
      topK: { label: "Top K", desc: "Trim the candidate pool to the strongest tokens." },
      topP: { label: "Top P", desc: "Apply nucleus filtering to the remaining distribution." },
      minP: { label: "Min P", desc: "Drop low-probability tail tokens using a minimum floor." },
      typical: { label: "Typical P", desc: "Prefer statistically typical tokens in the current distribution." },
      temp: { label: "Temperature", desc: "Flatten or sharpen the final distribution before selection." },
    },
    presets: {
