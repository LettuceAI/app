...
impl From<crate::one_shot_job::OneShotJobError> for DesignReferenceError {
...
impl crate::one_shot_job::OneShotFailure for DesignReferenceError {
...
mod tests {
    ...
    fn design_reference_messages_follow_legacy_order() {
        let document = crate::built_in_prompts::seed_document(BuiltInPromptId::DesignReference);
