...
use crate::companion::companion_memory_inference::MemoryFallbackKind;
use crate::{
...
mod tests {
    ...
    impl crate::generation::runtime_text::RuntimeTextSource for Repository {
        ...
        {
            Ok(Some(crate::generation::built_in_prompts::seed_document(id)))
        }
    }
