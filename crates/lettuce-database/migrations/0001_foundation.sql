...
CREATE TABLE legacy_import_stage_results (
    run_id TEXT NOT NULL REFERENCES legacy_import_runs(id) ON DELETE RESTRICT,
    stage TEXT NOT NULL CHECK (stage IN ('characters','groups','audio','settings','direct_conversations','group_conversations','usage_records','creation_helper')),
