...
impl CompanionConversationCreator for Database {
    ...
    ) -> Result<lettuce_conversations::CreateConversationResult, CompanionLaunchRepositoryError>
    {
        ...
        let memory = crate::conversation::conversation_creator::MemoryBinding::CompanionPool(
            owner.character_id,
        );
        crate::conversation::conversation_creator::create_with_hook(
            self,
            conversation,
            now,
            memory,
...
impl CompanionConversationSender for Database {
    fn begin_companion_send(
        ...
        crate::conversation::conversation_mutations::begin_send_with_hook(
            self,
            &command,
            now,
...
impl CompanionConversationContinuer for Database {
    ...
    ) -> Result<lettuce_conversations::ContinueConversationResult, CompanionContinueRepositoryError>
    {
        ...
        crate::conversation::conversation_mutations::begin_continue_with_hook(
            self,
            &command,
            now,
            |tx, turn_id| {
