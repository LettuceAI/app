...
impl PromptVariable {
    const fn placeholder(self) -> &'static str {
        match self {
            ...
            Self::TensionBand => "{{tension_band}}",
            Self::ClosenessScore => "{{closeness_score}}",
            Self::TrustScore => "{{trust_score}}",
            Self::AffectionScore => "{{affection_score}}",
            Self::TensionScore => "{{tension_score}}",
            ...
            Self::ToolSchemaSummary => "{{tool_schema_summary}}",
