...
pub use local::{
    ...
    MAX_SYNC_MEDIA_CHUNK_BYTES, MediaObjectPin, MediaObjectRemoval, MediaStoreError,
    OpenedMediaAsset, ReleasedMediaObject, SyncMediaAsset, install_backup_media_object,
    pin_media_objects, sniff_media_kind,
};
