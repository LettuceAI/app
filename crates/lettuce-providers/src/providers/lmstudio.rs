...
use crate::providers::openai_compatible::{AdapterError, AuthPlan, OpenAiWireProvider};
...
impl OpenAiWireProvider for LmStudio {
    ...
    fn reasoning_policy(&self) -> crate::providers::openai_compatible::ReasoningWirePolicy {
        crate::providers::openai_compatible::ReasoningWirePolicy::MaxCompletionTokensAndReasoningObject
    }
