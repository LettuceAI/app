...
use crate::{
    ...
    providers::gemini_generate::{Content, GeminiWireProvider, GenerateRequest},
};
...
fn cache_key(
    ...
    struct KeyPayload<'a> {
        ...
        contents: &'a [Content],
        tools: Option<&'a [crate::providers::gemini_generate::GeminiTool]>,
        tool_config: Option<&'a crate::providers::gemini_generate::ToolConfig>,
        ttl: &'a str,
