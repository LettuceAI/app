...
export const trMessages: DeepPartialMessageTree<LocaleMessages> = {
  ...
  characters: {
    ...
    conflicts: {
      title: "İnceleme gerekli", reviewTitle: "Bazı düzenlemeler kararınızı gerektiriyor",
      ...
      fieldsDiffer: "{{count}} alan farklı", currentVersion: "Geçerli sürüm",
      otherVersion: "Diğer sürüm", device: "Cihaz {{id}}", detected: "{{date}} tarihinde algılandı",
      emptyValue: "Boş", keepCurrent: "Geçerli olanı tut", useOther: "Diğerini kullan",
      loadError: "Çakışma ayrıntıları yüklenemedi.", resolveError: "Seçim kaydedilemedi. Hiçbir şey değiştirilmedi.",
      entities: { item: "Öğe", character: "Karakter", persona: "Persona", lorebook: "Bilgi kitabı", lorebookEntry: "Bilgi kitabı girdisi", promptTemplate: "İstem şablonu" },
      fields: {
        changedValue: "Değişen değer", name: "Ad", nickname: "Takma ad", title: "Başlık",
        description: "Açıklama", definition: "Tanım", scenario: "Senaryo",
        creatorNotes: "Oluşturucu notları", tags: "Etiketler", systemPrompt: "Sistem istemi",
        keywordDetection: "Anahtar kelime algılama", content: "İçerik", keywords: "Anahtar kelimeler",
        enabled: "Etkin", alwaysActive: "Her zaman etkin", priority: "Öncelik", entries: "İstem girdileri",
      },
    },
    lorebook: {
  ...
  hfBrowser: {
    ...
    bundle: {
      ...
      formatHint:
        "Bu biçimde yayımlanan depolarda arama yapın. Safetensors, hiçbir zaman GGUF sürümü yayımlamayan pek çok görsel deposuna ulaşır.",
      ...
      roles: { diffusion: "Difüzyon modeli", textEncoder: "Metin kodlayıcı", vae: "VAE", visionEncoder: "Görüntü kodlayıcı" },
    },
    clearSearch: "Aramayı temizle",
    filters: "Filtreler",
  ...
  usageAnalytics: {
    page: {
      ...
      nanoGpt: {
        ...
        weekly: "Haftalık kota", daily: "Günlük kota", monthly: "Aylık kota",
        used: "kullanıldı", consumed: "Tüketilen", remaining: "Kalan", limit: "Kota", resets: "Sıfırlanma",
        notReported: "Bildirilmedi", active: "Etkin", inactive: "Etkin değil",
