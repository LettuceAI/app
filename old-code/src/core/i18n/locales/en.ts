...
export const enMessages = {
  ...
  accessibility: {
    ...
    navigation: {
      styleTitle: "Navigation bar style",
      bottom: "Bottom Bar",
      bottomDesc: "Icon-only bar along the bottom edge",
      bottomLabels: "Bottom Bar with Labels",
      bottomLabelsDesc: "Adds text labels under each icon",
      dock: "Floating Dock",
      dockDesc: "Centered pill detached from the bottom edge",
      sidebar: "Sidebar",
      sidebarDesc: "Vertical icon rail docked to the window edge",
      floatingSidebar: "Floating Sidebar",
      floatingSidebarDesc: "Vertical pill detached from the window edge",
      ...
      posBottom: "Bottom",
      posCenter: "Center",
      itemsTitle: "Navigation Items",
      itemsDesc: "Drag to reorder. Create stays in the bar. Applies on desktop.",
      itemsReset: "Reset",
      itemsAdd: "Add item",
      itemsRemove: "Remove {{label}}",
      insideHeader: "Inside Header",
      insideHeaderDesc: "Navigation items centered inside the page header",
      header: "Header",
      headerDesc: "How the page header is drawn on main pages",
  ...
  components: {
    ...
    avatarGeneration: {
      ...
      refine: "Refine",
      apply: "Apply",
      queuedWithPosition: "Waiting in queue (position {{position}})",
      loadingModel: "Loading model...",
      preparing: "Preparing...",
      samplingProgress: "Step {{step}} of {{steps}}",
      finalizing: "Finalizing...",
      retryingWithOffload: "Ran out of memory. Retrying with CPU offload...",
      cancelGeneration: "Stop",
      cancelling: "Stopping...",
      paintMask: "Paint area",
      paintMaskHint: "Painted areas are regenerated. Everything else stays the same.",
      brushSize: "Brush size",
      clearMask: "Clear",
      upscale: "Upscale",
      upscaling: "Upscaling image...",
      upscaleFailed: "Failed to upscale image",
    },
    avatarPosition: {
  ...
  chats: {
    ...
    companionRelationship: {
      ...
      soulGrowthConfidence: "Confidence",
      soulGrowthLock: "Lock this fact",
      soulGrowthUnlock: "Unlock this fact",
      soulGrowthLocked: "Locked",
      soulGrowthPolicyHistorical: "Historical",
      soulGrowthPolicyCurrent: "Current",
      soulGrowthPolicyAdaptive: "Adaptive",
      growthKindAdd: "added",
  ...
  characters: {
    ...
    conflicts: {
      title: "Needs review",
      reviewTitle: "Some edits need your decision",
      reviewDescription: "Sync finished safely. Choose which version to keep for each item.",
      waitForSync: "Finish the current sync before reviewing these edits.",
      fieldsDiffer: "{{count}} fields differ",
      ...
      useOther: "Use other",
      loadError: "Conflict details could not be loaded.",
      resolveError: "That choice could not be saved. Nothing was changed.",
      entities: {
        item: "Item",
        character: "Character",
        persona: "Persona",
        lorebook: "Lorebook",
        lorebookEntry: "Lorebook entry",
        promptTemplate: "Prompt template",
      },
      fields: {
  ...
  editModel: {
    ...
    sdcpp: {
      ...
      loraPath: "LoRA path",
      strength: "Strength",
      loraKeywords: "Trigger keywords",
      loraKeywordsDescription: "Automatically added whenever this LoRA is active",
      editKeywords: "Edit keywords",
      keywordsRequired: "Add a LoRA keyword",
      keywordsRequiredDescription: "Add at least one trigger keyword before saving this model.",
      loraAlwaysActive: "Always active, no trigger keywords",
      markLoraAlwaysActive: "This LoRA needs no keywords, mark as always active",
      keywordEditorTitle: "LoRA keywords",
      keywordEditorDescription: "Enter one keyword per line, or separate keywords with commas. These remain editable even when discovered automatically.",
      keywordPlaceholder: "ArsMovieStill",
      keywordSaveFailed: "Could not save LoRA keywords",
      loraArchitecture: "Architecture",
      architectureUnknown: "Unknown architecture",
      loraCompatible: "Compatible",
      loraIncompatible: "Incompatible LoRA",
      loraIncompatibleDescription: "This LoRA targets a different model architecture and was not added.",
      removeIncompatibleLora: "Remove incompatible LoRAs before saving this model.",
      loraCompatibilityUnknown: "Compatibility unknown",
      loraCompatibilityUnknownDescription: "The LoRA does not identify its exact base architecture. You can try it, but compatibility is not guaranteed.",
    ...
    generationAdvanced: {
      ...
      description: "Sampling, VAE tiling, references, and high-resolution pass",
      modelDefault: "Model default",
      sampler: "Sampler",
      scheduler: "Scheduler",
      schedulerDescription: "Noise schedule used across sampling steps",
      imageGuidance: "Image CFG",
      imageGuidanceDescription: "Guidance strength for reference images",
      distilledGuidance: "Distilled guidance",
      distilledGuidanceDescription: "Model-specific guidance for distilled architectures",
      samplingSection: "Sampling",
      eta: "Eta",
      etaDescription: "Stochastic noise used by compatible samplers",
      flowShift: "Flow shift",
      flowShiftDescription: "Timestep shift for flow-based models",
      stepCaching: "Step caching",
      stepCachingDescription:
        "Reuse similar diffusion steps to speed up generation at a small quality cost",
      cacheMode: "Cache mode",
      cacheModeDisabled: "Disabled",
      cacheOption: "Cache tuning",
      cacheOptionPlaceholder: "threshold=0.2, start=0.15",
      slgSection: "Skip-layer guidance",
      slgSectionDescription:
        "Guides sampling by skipping transformer layers. Leave the scale empty to keep it off.",
      slgScale: "Guidance scale",
      slgDisabled: "Off",
      slgLayers: "Skipped layers",
      slgLayerStart: "Start fraction",
      slgLayerEnd: "End fraction",
      vaeSection: "VAE tiling",
      vaeTiling: "Use VAE tiling",
      vaeTilingDescription: "Decode the image in tiles to reduce peak memory",
      tileWidth: "Tile width",
      tileHeight: "Tile height",
      tileOverlap: "Tile overlap",
      referencesSection: "Reference images",
      autoResizeReferences: "Auto-resize references",
      autoResizeReferencesDescription: "Match reference images to the generation size",
      increaseReferenceIndex: "Increase reference index",
      increaseReferenceIndexDescription: "Assign each reference its own positional index",
      hiresSection: "High-resolution pass",
      hiresFix: "Enable high-resolution pass",
      hiresFixDescription: "Upscale and refine the first result with a second pass",
      upscaler: "Upscaler",
      scale: "Scale",
      targetWidth: "Target width",
      targetHeight: "Target height",
      secondPassSteps: "Second-pass steps",
    ...
    generationDescriptions: {
      ...
      sdSampler: "Diffusion sampler used by the image engine",
      sdSeed: "Leave blank for random generations",
      sdDenoise: "Edit strength for reference-based generations",
      sdNegativePrompt: "Applied to every image request for this model",
  ...
  playground: {
    ...
    settings: {
      ...
      noModel: "No image model selected",
      ...
      hiresNone: "No upscalers installed",
      hiresScale: "Scale",
    ...
    prompt: {
      ...
      pickInitImage: "Choose a starting image",
      pickInitImageFile: "From file",
      pickInitImageHistory: "From history",
      pickFromHistory: "Pick from your generations",
      noHistoryImages: "No past generations yet. Generate some images first.",
      clearInitImage: "Remove",
      strength: "Strength",
      initImageFailed: "Could not load that image",
      initImageSet: "Starting image set",
    },
    progress: {
      starting: "Starting",
      ...
      generating: "Generating",
      sampling: "Sampling",
      retrying: "Retrying with lower memory use",
    },
    feed: {
      loadOlder: "Load older generations",
      cancel: "Cancel generation",
      failed: "Generation failed",
      cancelled: "Generation cancelled",
      interrupted: "Generation was interrupted",
      delete: "Delete generation",
      sendToImg2img: "Use as starting image",
      upscale: "Upscale",
      upscaleFailed: "Upscale failed",
      copyPrompt: "Copy prompt",
      promptCopied: "Prompt copied",
      reuseSeed: "Reuse this seed",
      seedReused: "Seed set to {{seed}}",
      regenerate: "Regenerate with same settings",
      modelMissing: "That model is no longer available",
      deleteTitle: "Delete generation",
      deleteBody: "Remove this generation from the feed. You can keep the image files or delete them from disk too.",
      deleteKeepImages: "Delete entry, keep images",
      deleteWithImages: "Delete entry and images",
      deleteFailed: "Delete failed",
    },
  },
  loraLibrary: {
    ...
    importSuccess: "LoRA imported",
    importFailed: "Import failed",
    installedEmpty: "No LoRAs in your library yet",
    installedEmptyHint: "Download one from CivitAI or import a local file.",
    noKeywords: "No trigger keywords yet",
    discover: "Find keywords",
    discoverFailed: "Keyword discovery failed",
    editKeywords: "Edit keywords",
    deleteTitle: "Delete LoRA",
    deleteMessage: "Delete {{name}} from your library? The file is removed from disk.",
    deleteConfirm: "Delete",
    deleteSuccess: "LoRA deleted",
    deleteFailed: "Delete failed",
    keywordsTitle: "Trigger keywords",
    keywordsHint: "One keyword per line. They are added to prompts that use this LoRA.",
    keywordsSave: "Save keywords",
    keywordsRequired: "Add at least one trigger keyword.",
    keywordsSaveFailed: "Saving keywords failed",
    searchPlaceholder: "Search LoRAs on CivitAI...",
    sortTitle: "Sort results",
    sortHighestRated: "Highest rated",
    sortMostDownloaded: "Most downloaded",
    sortNewest: "Newest",
    periodTitle: "Time period",
    periodAllTime: "All time",
    periodYear: "Past year",
    periodMonth: "Past month",
    periodWeek: "Past week",
    periodDay: "Today",
    baseModelAll: "All base models",
    pureModeNote: "Pure mode is on. Only safe-for-work results are shown.",
    noResults: "No LoRAs found",
    noResultsHint: "Try a different search term.",
    loadMore: "Load more",
    by: "by {{name}}",
    ...
    backToCaller: "Back",
    copyLink: "Copy CivitAI link",
    copied: "Copied to clipboard",
    alwaysActive: "Always active, no trigger keywords",
    versions: "Versions",
    triggerWords: "Trigger words",
    filesTitle: "Files",
    noSafeFiles: "This version has no safetensors files.",
    primaryFile: "Primary",
    download: "Download",
    downloaded: "In library",
    downloadQueued: "Download queued",
    downloadFailed: "Download failed",
    detailLoadFailed: "Could not load this model.",
    openLibrary: "Open LoRA library",
    openLibraryDescription: "Browse and download LoRAs. Unsaved model changes are discarded.",
    tokenTitle: "CivitAI API token",
    tokenBody: "Add a CivitAI API token to download restricted or early-access files.",
    tokenGetOne: "Get a token on CivitAI",
    ...
    tokenAdd: "Add token",
    tokenReplace: "Replace token",
    tokenRemove: "Remove token",
    tokenPrivacy: "The token is stored locally and only sent to CivitAI.",
  },
  hfAuth: {
    gatedBody:
  ...
  hfBrowser: {
    ...
    modeLlm: "LLM",
    modeImage: "Image",
    destinationLlamaCpp: "Local llama.cpp",
    destinationLocalImage: "Local Image",
    destinationSelectDownload: "Select & Download",
    bundle: {
      title: "Build an image model",
      subtitle: "Choose a compatible architecture and components. LettuceAI pins, verifies, downloads, and registers the complete bundle.",
      ...
      repositoryPlaceholder: "author/repository or Hugging Face URL",
      searchPlaceholder: "Search compatible repositories or paste a Hugging Face URL",
      selectFile: "Select",
      selectFileHeading: "Choose the {{role}} file",
      compatibleFiles: "{{count}} compatible files",
      noCompatibleFiles: "No compatible {{role}} files were found in this repository.",
      noCompatibleRepositories: "No compatible repositories found for this component. Try another search or paste a repository URL.",
      recommendedPrefilled: "Showing the recommended repository for this component.",
      reviewTitle: "Review and download",
      addToken: "Add Hugging Face token",
      authHint: "This repository may require a Hugging Face token or accepting its license.",
      selectionInvalid: "The {{role}} selection could not be restored. Select it again.",
      gated: "Gated",
      hfAccess: "Hugging Face access",
      tokenPlaceholder: "Hugging Face access token",
      saveToken: "Save token",
      tokenPrivacy: "The token is validated before saving and is never returned to the interface or placed in download URLs.",
      authInvalid: "Hugging Face authentication failed",
      textToImage: "Text to image",
      imageEditing: "Image editing",
      displayName: "Model display name",
      preDownloadEstimate: "Pre-download runnability estimate",
      runtimeRequired: "Install and select a compatible stable-diffusion.cpp engine in Local Image settings before downloading.",
      calculating: "Calculating placement with your saved compute policy…",
      bundleSize: "Bundle size",
      placement: "Placement",
      devices: "Devices",
      planConcurrent: "Concurrent",
      planTimeShare: "Phased",
      planDefaultBackend: "Default backend",
      placementHeading: "Component placement",
      componentDit: "Diffusion core",
      componentVae: "VAE",
      componentConditioner: "Text encoder",
      splitAcross: "Split across devices",
      reserve: "reserve",
      deviceUsable: "{{free}} free · {{budget}} usable of {{total}}",
      availableRam: "{{value}} system RAM available",
      downloadCreate: "Download and create model",
      queueFailed: "Could not start the image bundle download",
      verifying: "Verifying",
      registrationFailed: "Model creation failed",
      retryRegistration: "Retry model creation",
      retryDownloads: "Retry incomplete downloads",
      completeTitle: "Image model is ready",
      completeBody: "{{name}} is verified, registered, and available in image selectors.",
      openModel: "Open model",
      steps: "steps",
      manageEngine: "Manage stable-diffusion.cpp engine",
      roles: {
  ...
  imageGeneration: {
    ...
    local: {
      sectionTitle: "Local image models",
      managedTitle: "Managed stable-diffusion.cpp",
      managedDescription:
        "Install a curated model and a standalone engine build. The engine stops local text generation before using the accelerator, so both workloads do not compete for GPU memory.",
      refreshBuilds: "Refresh engine builds",
      modelVariant: "Model variant",
      engineVersion: "Engine version",
      computeBackend: "Compute backend",
      latest: "latest",
      installSelected: "Install selected",
      installQueued: "Local image model queued",
      sceneReady: "Scene references",
      textToImage: "Text to image",
      referenceCount: "Up to {{count}} references",
      loraReady: "LoRA",
      ...
      upscaler: {
        title: "Upscaler",
        description:
          "ESRGAN model ({{size}}) used for the Upscale action and the high-resolution pass.",
        installed: "Installed",
        install: "Install",
      },
      engineManager: {
        ...
        description:
          "Install and choose the stable-diffusion.cpp build used for local image generation.",
        installedTitle: "Installed Versions",
        notInstalled: "Engine Not Installed",
        notInstalledBody: "Install an engine version before setting up local image models.",
        active: "Active",
        useVersion: "Use This Version",
        deleteVersion: "Delete {{version}}",
        deleteConfirmTitle: "Delete {{version}}?",
        deleteConfirm: "This removes this engine build from disk.",
        deleteActiveConfirm:
          "This is the active build. Another installed version will be selected automatically, if available.",
        addVersion: "Install Another Version",
        installTitle: "Install Engine",
        version: "Version",
        variant: "Build Variant",
        recommended: "Recommended",
        detectedGpu: "Detected {{device}}. The best compatible build was selected automatically.",
        noDiscreteGpu: "No discrete GPU was detected. The safest compatible build was selected.",
        manualVariant: "Manually selected. {{backend}} is recommended for this device.",
        install: "Install Engine",
        alreadyInstalled: "Already Installed",
        installing: "Installing engine",
        queued: "Engine download queued",
        downloads: "Engine Downloads",
        cancelDownload: "Cancel engine download",
        installComplete: "Installed and ready",
        installFailed: "Engine installation failed",
        switchFailed: "Could not switch engine version",
        ...
        computePolicyDescription:
          "Choose which GPUs this engine may use and how Stable Diffusion divides model work between them.",
        computePolicyConfigure: "Configure",
        computePolicyLoading: "Reading compatible GPUs...",
        computePolicySave: "Save GPU Policy",
        computePolicySaved: "GPU policy saved",
        computePolicySaveFailed: "Could not save GPU policy",
        computeMode: "Device selection",
        computeModeAuto: "Automatic",
        computeModeAutoDescription:
          "Let stable-diffusion.cpp choose the best eligible GPU placement for each model.",
        computeModeSingle: "Single GPU",
        computeModeSingleDescription: "Keep all GPU work on one selected device.",
        computeModeMulti: "Multiple GPUs",
        computeModeMultiDescription:
          "Use two or more selected devices when a model benefits from splitting.",
        eligibleGpus: "Eligible GPUs",
        noEligibleGpus: "No compatible discrete GPU is available to this engine build.",
        vramBudget: "VRAM budget",
        vramBudgetAuto: "Auto",
        vramBudgetHint: "{{available}} currently free; leave blank for automatic.",
        vramBudgetFor: "VRAM budget for {{device}}",
        splitMode: "Multi-GPU split",
        splitLayer: "Layer split",
        splitLayerDescription: "Distribute complete model layers between GPUs.",
        splitRow: "Row split",
        splitRowDescription: "Split individual tensor rows across CUDA GPUs.",
        rowCudaOnly: "Row split requires a CUDA engine build.",
        computeSummaryAuto: "Automatic · {{count}} eligible GPUs",
        computeSummarySingle: "Single GPU · {{device}}",
        computeSummaryMulti: "Multiple GPUs · {{count}} selected",
      },
      modelLibrary: {
        title: "Models",
        description: "Download models to generate images locally on this device.",
        refreshHardware: "Refresh hardware",
        refreshingHardware: "Rechecking...",
        refreshHardwareDescription:
          "Re-read GPU memory and recalculate hardware fit for the visible model variants.",
        refreshFailed: "Could not refresh model hardware information",
        variant: "Variant",
        download: "Download",
      ...
      hub: {
        unsupportedTitle: "Not supported on this system",
        desktopOnlyTitle: "Desktop only",
        desktopOnlyBody: "The Stable Diffusion engine is available in the desktop app.",
      },
    },
  },
  logs: {
  ...
  sync: {
    ...
    progress: {
      ...
      phases: {
        ...
        separatingChatBranches: "Separating concurrent chat branches",
        waitingForDatabase: "Waiting for the local database",
        comparingFiles: "Comparing files",
        exchangingFiles: "Exchanging files",
      },
      databaseWait: {
        title: "Local database is busy",
        description: "Another app task is finishing a database write. Sync is paused safely and will retry automatically.",
        retry: "Retry {{current}} of {{total}} in {{delay}}",
      },
    },
  ...
  editPrompt: {
    ...
    conditions: {
      ...
      isLocalImageGenerationModel: "Local image generation model",
      isSceneGenerationLocalImageModel: "Scene generation uses local image model",
      hasScene: "Has scene",
      hasSceneDirection: "Has scene direction",
    ...
    describe: {
      ...
      localImageGenerationModel: "image generation model is local",
      remoteImageGenerationModel: "image generation model is not local",
      sceneGenerationLocalImageModel: "scene generation uses a local image model",
      sceneGenerationRemoteImageModel: "scene generation uses a remote image model",
  ...
  usageAnalytics: {
    page: {
      ...
      nanoGpt: {
        tab: "NANOGPT",
        subtitle: "Provider-reported subscription quota and usage",
        account: "NanoGPT account",
        noAccount: "No NanoGPT account configured",
        noAccountDescription:
          "Add a NanoGPT provider with an API key to fetch subscription usage.",
        fetchFailed: "Could not fetch NanoGPT usage",
        noQuota: "No quota window was returned",
        noQuotaDescription:
          "NanoGPT responded successfully, but did not include weekly, daily, or monthly quota data.",
        authoritative: "Reported directly by NanoGPT. Local chat records are not used here.",
        ...
        active: "Active",
        inactive: "Inactive",
        localTitle: "Local activity",
        localSubtitle:
          "Recorded by LettuceAI for NanoGPT requests. Counted separately from the quota above.",
        localWindowQuota: "This quota window",
        localWindow30d: "Last 30 days",
        localWindowAll: "All time",
        localRequests: "Requests",
        localTokens: "Tokens",
        localCost: "Cost",
        localAvgTokens: "Avg tokens / request",
        localEmpty: "No NanoGPT requests recorded in this range.",
        localViewSummary: "Summary",
        localViewList: "Request list",
        localShowMore: "Show {{count}} more",
        localFailed: "{{count}} failed",
        warningInfo:
          "LettuceAI rechecks your quota when a request runs through NanoGPT, at most once every 5 minutes, and warns at 75%, 90%, and 100% usage. Each warning is shown once per quota window.",
        warningTitle: "NanoGPT quota at {{percent}}%",
        warningDescription: "{{account}} has {{remaining}} remaining. Resets {{reset}}.",
        warningDescriptionNoReset: "{{account}} has {{remaining}} remaining.",
      },
      today: "Today",
      last7Days: "7 Days",
      last30Days: "30 Days",
