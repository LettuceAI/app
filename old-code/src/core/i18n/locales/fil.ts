...
export const filMessages: DeepPartialMessageTree<LocaleMessages> = {
  ...
  characters: {
    ...
    conflicts: {
      title: "Kailangang suriin", reviewTitle: "May mga pagbabagong kailangan ng desisyon mo",
      ...
      fieldsDiffer: "{{count}} field ang magkaiba", currentVersion: "Kasalukuyang bersyon",
      otherVersion: "Ibang bersyon", device: "Device {{id}}", detected: "Natukoy noong {{date}}",
      emptyValue: "Walang laman", keepCurrent: "Panatilihin ito", useOther: "Gamitin ang iba",
      loadError: "Hindi ma-load ang detalye ng conflict.", resolveError: "Hindi na-save ang pinili. Walang binago.",
      entities: { item: "Item", character: "Character", persona: "Persona", lorebook: "Lorebook", lorebookEntry: "Entry sa lorebook", promptTemplate: "Prompt template" },
      fields: {
        changedValue: "Binagong value", name: "Pangalan", nickname: "Palayaw", title: "Pamagat",
        description: "Paglalarawan", definition: "Depinisyon", scenario: "Senaryo",
        creatorNotes: "Tala ng gumawa", tags: "Mga tag", systemPrompt: "System prompt",
        keywordDetection: "Pagtukoy ng keyword", content: "Nilalaman", keywords: "Mga keyword",
        enabled: "Naka-enable", alwaysActive: "Laging aktibo", priority: "Priyoridad", entries: "Mga prompt entry",
      },
    },
    lorebook: {
  ...
  hfBrowser: {
    ...
    bundle: {
      ...
      formatHint:
        "Maghanap ng mga repository na inilathala sa format na ito. Naaabot ng Safetensors ang maraming image repository na hindi kailanman naglalabas ng GGUF build.",
      ...
      roles: { diffusion: "Diffusion model", textEncoder: "Text encoder", vae: "VAE", visionEncoder: "Vision encoder" },
    },
  ...
  usageAnalytics: {
    page: {
      ...
      nanoGpt: {
        ...
        weekly: "Lingguhang quota", daily: "Arawang quota", monthly: "Buwanang quota",
        used: "nagamit", consumed: "Nagamit", remaining: "Natitira", limit: "Quota", resets: "Magre-reset",
        notReported: "Hindi iniulat", active: "Aktibo", inactive: "Hindi aktibo",
