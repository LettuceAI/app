...
export const viMessages: DeepPartialMessageTree<LocaleMessages> = {
  ...
  characters: {
    ...
    conflicts: {
      title: "Cần xem lại", reviewTitle: "Một số chỉnh sửa cần quyết định của bạn",
      ...
      fieldsDiffer: "{{count}} trường khác nhau", currentVersion: "Phiên bản hiện tại",
      otherVersion: "Phiên bản khác", device: "Thiết bị {{id}}", detected: "Phát hiện lúc {{date}}",
      emptyValue: "Trống", keepCurrent: "Giữ bản hiện tại", useOther: "Dùng bản khác",
      loadError: "Không thể tải chi tiết xung đột.", resolveError: "Không thể lưu lựa chọn. Không có gì thay đổi.",
      entities: { item: "Mục", character: "Nhân vật", persona: "Persona", lorebook: "Sổ kiến thức", lorebookEntry: "Mục sổ kiến thức", promptTemplate: "Mẫu lời nhắc" },
      fields: {
        changedValue: "Giá trị đã đổi", name: "Tên", nickname: "Biệt danh", title: "Tiêu đề",
        description: "Mô tả", definition: "Định nghĩa", scenario: "Kịch bản",
        creatorNotes: "Ghi chú người tạo", tags: "Thẻ", systemPrompt: "Lời nhắc hệ thống",
        keywordDetection: "Phát hiện từ khóa", content: "Nội dung", keywords: "Từ khóa",
        enabled: "Đã bật", alwaysActive: "Luôn hoạt động", priority: "Ưu tiên", entries: "Mục lời nhắc",
      },
    },
    lorebook: {
      keywords: "TỪ KHÓA",
  ...
  hfBrowser: {
    ...
    bundle: {
      ...
      formatHint:
        "Tìm các kho lưu trữ được phát hành ở định dạng này. Safetensors bao quát nhiều kho ảnh không bao giờ phát hành bản dựng GGUF.",
      ...
      roles: { diffusion: "Mô hình khuếch tán", textEncoder: "Bộ mã hóa văn bản", vae: "VAE", visionEncoder: "Bộ mã hóa thị giác" },
    },
    clearSearch: "Xóa tìm kiếm",
    filters: "Bộ lọc",
  ...
  usageAnalytics: {
    page: {
      ...
      nanoGpt: {
        ...
        weekly: "Hạn mức tuần", daily: "Hạn mức ngày", monthly: "Hạn mức tháng",
        used: "đã dùng", consumed: "Đã dùng", remaining: "Còn lại", limit: "Hạn mức", resets: "Đặt lại",
        notReported: "Không được báo cáo", active: "Hoạt động", inactive: "Không hoạt động",
